...
BOOL func_138(Player plParam0) // Position - 0xAB6F Hash - 0x16FCD261 ^0xAB60A6A6
{
	Player player;
...
BOOL func_139(Player plParam0) // Position - 0xAB93 Hash - 0xE40D6326 ^0xE40D6326
{
	Player player;
...
BOOL func_140(Player plParam0, int iParam1) // Position - 0xABB1 Hash - 0x7CD5054C ^0x870BEA81
{
...
void func_293() // Position - 0x344AC Hash - 0xFE72808B ^0xD6C2186A
{
...
void func_294(var uParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, char* sParam7, int iParam8, int iParam9, int iParam10, int iParam11) // Position - 0x344F6 Hash - 0x607C6130 ^0x706A73DE
{
...
void func_295(var uParam0, char* sParam1, int iParam2, int iParam3, int iParam4) // Position - 0x34526 Hash - 0x6C5FBB5E ^0xD460273B
{
	uParam0->f_1 = sParam1;
	uParam0->f_2 = iParam3;
...
void func_296(var uParam0, int iParam1, char* sParam2) // Position - 0x34553 Hash - 0x56FFD57E ^0x2EC6E3FD
{
