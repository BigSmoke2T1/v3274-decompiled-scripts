				...
				case 3:
					if (func_457(&scaleform, &unk504))
					{
						...
						if (!ENTITY::IS_ENTITY_DEAD(func_506(), false))
						{
							...
							if (echLocal_356 == 145 /*_CHAR_NULL*/)
							...
							switch (echLocal_356)
							{
								...
								case 19 /*CHAR_LAMAR*/:
									...
									PED::SET_PED_COMPONENT_VARIATION(func_506(), 5 /*PV_COMP_HAND*/, 2, 0, 0);
									break;
				...
				case 6:
					switch (num3)
					{
						...
						case 1:
							...
							{
								func_419(&(unk504.f_57), "DARTS_TITLE", 0, 4000, 12 /*HUD_COLOUR_YELLOW*/, 2, false, 0);
								num3 = num3 + 1;
							}
							break;
				...
				case 13:
					...
					switch (num3)
					{
						case 0:
							...
							HUD::CLEAR_PRINTS();
							TASK::TASK_LOOK_AT_ENTITY(uLocal_262[0], uLocal_262[1], 5000, 2049 /*SLF_SLOW_TURN_RATE | 2048*/, 3);
							func_443(&unk1786);
							num3 = num3 + 1;
							break;
...
void func_44(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x47A6 Hash - 0xF7EC0F56 ^0x677E53AA
{
	...
	if (bLocal_267)
	{
		...
		else if (PAD::IS_CONTROL_JUST_PRESSED(0 /*PLAYER_CONTROL*/, 234 /*INPUT_SCRIPT_PAD_LEFT*/) || PAD::IS_CONTROL_JUST_PRESSED(0 /*PLAYER_CONTROL*/, 235 /*INPUT_SCRIPT_PAD_RIGHT*/) && uParam0->f_248 == 1 && flag)
		{
			uParam0->f_457 = 0;
		...
		else if (PAD::IS_CONTROL_JUST_PRESSED(0 /*PLAYER_CONTROL*/, 211 /*INPUT_FRONTEND_LEADERBOARD*/) || PAD::IS_DISABLED_CONTROL_JUST_PRESSED(0 /*PLAYER_CONTROL*/, 211 /*INPUT_FRONTEND_LEADERBOARD*/) && flag && bLocal_285 || !PLAYER::IS_PLAYER_ONLINE())
		{
			uParam1->f_680 = 1;
			func_122(&(uParam1->f_509), false, false, true, true);
			func_121(&(uParam1->f_509), "DARTS_CONT" /*Continue*/, 2, 215, 1, 1, 0);
...
void func_130(var uParam0, var uParam1) // Position - 0x8AAC Hash - 0xA298C3F7 ^0x131768E2
{
	...
	if (uParam1->f_246.f_2 > 0)
	{
		...
		else if (func_131(uParam1, 188 /*INPUT_FRONTEND_UP*/))
		{
		...
		else if (func_131(uParam1, 187 /*INPUT_FRONTEND_DOWN*/))
		{
	...
	else if (func_131(uParam1, 204 /*INPUT_FRONTEND_Y*/))
	{
...
void func_255(var uParam0, var uParam1, var uParam2) // Position - 0x167BE Hash - 0x5D6F4F50 ^0x77FF5340
{
	...
	switch (uParam0->f_2)
	{
		...
		case 2:
			if (PAD::IS_CONTROL_JUST_PRESSED(2 /*FRONTEND_CONTROL*/, 201 /*INPUT_FRONTEND_ACCEPT*/) || bLocal_275 && bLocal_274)
				bLocal_265 = true;
...
BOOL func_300(var uParam0, var uParam1, var uParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, int iParam6) // Position - 0x188DD Hash - 0x31F658D0 ^0xE5DE1EA8
{
	...
	switch (iParam6)
	{
		case 0:
			...
			{
				if (!(PAD::IS_CONTROL_JUST_PRESSED(2 /*FRONTEND_CONTROL*/, 223 /*INPUT_SCRIPT_RDOWN*/) && bLocal_99) && !bParam4)
				{
					bLocal_96 = true;
					bLocal_97 = true;
...
BOOL func_301(var uParam0) // Position - 0x18B52 Hash - 0x1DF7D1BA ^0xFCABE73D
{
	...
	controlNormal = PAD::GET_CONTROL_NORMAL(2 /*FRONTEND_CONTROL*/, 220 /*INPUT_SCRIPT_RIGHT_AXIS_X*/);
	controlNormal2 = PAD::GET_CONTROL_NORMAL(2 /*FRONTEND_CONTROL*/, 221 /*INPUT_SCRIPT_RIGHT_AXIS_Y*/);
...
void func_306(var uParam0, int iParam1) // Position - 0x18E0C Hash - 0xC60B4B00 ^0xB9D72368
{
	...
	num = 0.033367f;
	flag = false;
	controlUnboundNormal = PAD::GET_CONTROL_UNBOUND_NORMAL(2 /*FRONTEND_CONTROL*/, 218 /*INPUT_SCRIPT_LEFT_AXIS_X*/);
	controlUnboundNormal2 = PAD::GET_CONTROL_UNBOUND_NORMAL(2 /*FRONTEND_CONTROL*/, 219 /*INPUT_SCRIPT_LEFT_AXIS_Y*/);
	controlNormal = PAD::GET_CONTROL_NORMAL(2 /*FRONTEND_CONTROL*/, 220 /*INPUT_SCRIPT_RIGHT_AXIS_X*/);
	controlNormal2 = PAD::GET_CONTROL_NORMAL(2 /*FRONTEND_CONTROL*/, 221 /*INPUT_SCRIPT_RIGHT_AXIS_Y*/);
...
void func_330(var uParam0) // Position - 0x1A121 Hash - 0x7C2D8FD7 ^0x9849CA20
{
	...
	if (iLocal_28 == 1 && iLocal_29 < 3 && *uParam0 != 5)
		if (PAD::IS_CONTROL_PRESSED(2 /*FRONTEND_CONTROL*/, 201 /*INPUT_FRONTEND_ACCEPT*/) || PAD::IS_CONTROL_JUST_PRESSED(2 /*FRONTEND_CONTROL*/, 223 /*INPUT_SCRIPT_RDOWN*/) && bLocal_97)
			*uParam0 = 6;
...
void func_348(int* piParam0) // Position - 0x1AAA6 Hash - 0x294B53C7 ^0x1978B7FB
{
	if (piParam0->f_9 != 0)
	{
...
BOOL func_351(var uParam0, var uParam1, var uParam2) // Position - 0x1AB9F Hash - 0xC80BA06D ^0x4FE89593
{
	...
	if (!func_3(&(uParam0->f_666), 7))
	{
		...
		if (PAD::IS_CONTROL_JUST_PRESSED(2 /*FRONTEND_CONTROL*/, 201 /*INPUT_FRONTEND_ACCEPT*/) || num == 1 && uParam0->f_660 == 2)
		{
...
void func_374(ePedComponentType epctParam0, char* sParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x1F4A1 Hash - 0x266829EB ^0xA645288
{
	int num;
	float num2;
	float num3;
...
void func_377(ePedComponentType epctParam0, BOOL bParam1) // Position - 0x1F716 Hash - 0x88A2313D ^0xBBA11C08
{
	int num;
...
int func_382(int* piParam0, ePedComponentType epctParam1, int iParam2) // Position - 0x1F8CA Hash - 0x3D898937 ^0xDE6CDFC0
{
	if (!PAD::IS_USING_KEYBOARD_AND_MOUSE(2 /*FRONTEND_CONTROL*/))
		return 0;
...
int func_384(int* piParam0) // Position - 0x1F95A Hash - 0x8EC0FC20 ^0xC90180EF
{
	...
	if (controlNormal > 0.8f || PAD::IS_CONTROL_PRESSED(2 /*FRONTEND_CONTROL*/, 190 /*INPUT_FRONTEND_RIGHT*/) || PAD::IS_DISABLED_CONTROL_PRESSED(2 /*FRONTEND_CONTROL*/, 190 /*INPUT_FRONTEND_RIGHT*/))
	{
		if (!func_428(piParam0))
		{
			func_383(piParam0);
...
void func_385(var uParam0) // Position - 0x1F9DF Hash - 0xD489864E ^0x9CAD1B19
{
	...
	func_352(false, false);
	HUD::GET_HUD_COLOUR(141 /*HUD_COLOUR_DARTS*/, &r, &g, &b, &a);
	func_398(r, g, b, a, 1);
	func_397(1, 2, 0, 0, 0);
	func_396(1, 2, 1, 1, 1);
	...
	func_374(0 /*PV_COMP_HEAD*/, "DARTS_LEGS", 0, true, false, false, false);
	func_389(0 /*PV_COMP_HEAD*/, func_381(uParam0->f_662 + 1, true), false);
	func_374(1 /*PV_COMP_BERD*/, "DARTS_SETS", 0, true, false, false, false);
	func_389(1 /*PV_COMP_BERD*/, func_381(uParam0->f_664 + 1, false), false);
	func_388(2, 141 /*HUD_COLOUR_DARTS*/, 141 /*HUD_COLOUR_DARTS*/, 1);
	func_374(2 /*PV_COMP_HAIR*/, "DARTS_START", 0, true, false, false, false);
	func_387(0);
	func_406(uParam0->f_660, true, 1);
	...
	func_386(201 /*INPUT_FRONTEND_ACCEPT*/, "ITEM_SELECT" /*Select*/, -1, false);
	func_386(202 /*INPUT_FRONTEND_CANCEL*/, "IB_QUIT" /*Quit*/, -1, false);
	return;
}
...
void func_389(ePedComponentType epctParam0, Hash hParam1, BOOL bParam2) // Position - 0x1FBCC Hash - 0x7E99DBFF ^0x86F70EFB
{
	int num;
	float num2;
	float num3;
...
int func_399(int* piParam0, ePedComponentType epctParam1, int iParam2) // Position - 0x1FF7D Hash - 0xA3F17531 ^0x1933C7C7
{
	if (!PAD::IS_USING_KEYBOARD_AND_MOUSE(2 /*FRONTEND_CONTROL*/))
		return 0;
...
int func_400(int* piParam0) // Position - 0x1FFF5 Hash - 0x4C418C22 ^0x9A45ABFE
{
	...
	if (controlNormal < -0.8f || PAD::IS_CONTROL_PRESSED(2 /*FRONTEND_CONTROL*/, 189 /*INPUT_FRONTEND_LEFT*/))
	{
		if (!func_428(piParam0))
		{
			func_383(piParam0);
...
BOOL func_401(int* piParam0) // Position - 0x2006F Hash - 0xA765E6CF ^0x99378079
{
	...
	if (controlNormal > 0.8f || PAD::IS_CONTROL_PRESSED(2 /*FRONTEND_CONTROL*/, 187 /*INPUT_FRONTEND_DOWN*/))
	{
		if (!func_428(piParam0))
		{
			func_383(piParam0);
...
BOOL func_402(int* piParam0) // Position - 0x200E7 Hash - 0x5BBF6BF1 ^0xB57F0824
{
	...
	if (controlNormal < -0.8f || PAD::IS_CONTROL_PRESSED(2 /*FRONTEND_CONTROL*/, 188 /*INPUT_FRONTEND_UP*/))
	{
		if (!func_428(piParam0))
		{
			func_383(piParam0);
...
void func_413(var uParam0) // Position - 0x208B8 Hash - 0xE2DBFAA7 ^0xE2DBFAA7
{
	...
	func_389(0, 1, false);
	func_374(1 /*PV_COMP_BERD*/, "DARTS_SETS", 0, true, false, false, false);
	func_389(1 /*PV_COMP_BERD*/, 1, false);
	func_374(2 /*PV_COMP_HAIR*/, "DARTS_START", 0, true, false, false, false);
...
void func_447(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, Any* panParam7, var uParam8) // Position - 0x2169D Hash - 0x5D3236E7 ^0x393F00A2
{
	...
	else
	{
		...
		{
			uLocal_262[1] = PED::CREATE_PED(26 /*PED_TYPE_MISSION*/, hLocal_298, uParam1.f_3, fParam0, true, true);
		}
...
BOOL func_459(int* piParam0) // Position - 0x21ECD Hash - 0x55978EE6 ^0xF39227AE
{
	switch (piParam0->f_9)
	{
		case 0:
...
void func_486(var uParam0) // Position - 0x231A4 Hash - 0xE19A9C4 ^0x866194B1
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0) && !PED::IS_PED_INJURED(*uParam0))
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_262[0]))
			TASK::TASK_LOOK_AT_ENTITY(0, uLocal_262[0], 8000, 2049 /*SLF_SLOW_TURN_RATE | 2048*/, 3);
