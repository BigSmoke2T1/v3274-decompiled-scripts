...
BOOL func_2() // Position - 0x12B Hash - 0xEEAF5DD9 ^0x13C1CCC2
{
	...
	if (!PED::IS_PED_INJURED(Global_101254))
	{
		...
		{
			if (ENTITY::IS_ENTITY_PLAYING_ANIM(Global_101254, &uLocal_244, &uLocal_276, 3))
			{
...
BOOL func_26() // Position - 0xB81 Hash - 0xEEAF5DD9 ^0x13C1CCC2
{
	...
	if (!PED::IS_PED_INJURED(Global_101254))
	{
		if (ENTITY::DOES_ENTITY_EXIST(obLocal_238))
		{
			if (ENTITY::IS_ENTITY_PLAYING_ANIM(Global_101254, &uLocal_244, &uLocal_260, 3))
			{
				if (FIRE::IS_ENTITY_ON_FIRE(Global_101254))
				{
					TASK::STOP_ANIM_PLAYBACK(Global_101254, 0, false);
				...
				else
				{
					...
					TASK::TASK_SYNCHRONIZED_SCENE(Global_101254, iLocal_292, &uLocal_244, &uLocal_276, 8f, -8f, 257, 0, 8f, 0);
					return true;
				}
			}
			else
...
int func_29(int iParam0, Ped pedParam1) // Position - 0xE07 Hash - 0xD1960A5B ^0x3A103378
{
	...
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		else if (pedParam1 == func_30(Global_101254) && pedParam1 != 0)
		{
			Global_101254 = 0;
		}
	}
...
void func_37() // Position - 0xFB7 Hash - 0x4062D4CB ^0xC009B050
{
	...
	while (!ENTITY::DOES_ENTITY_EXIST(Global_101254) || !STREAMING::HAS_MODEL_LOADED(hLocal_239))
	{
		SYSTEM::WAIT(0);
	}
	...
	obLocal_238 = OBJECT::CREATE_OBJECT(hLocal_239, ENTITY::GET_ENTITY_COORDS(Global_101254, true), true, true, false);
	ENTITY::ATTACH_ENTITY_TO_ENTITY(obLocal_238, Global_101254, PED::GET_PED_BONE_INDEX(Global_101254, 28422), 0f, 0f, 0f, 0f, 0f, 0f, false, false, false, false, 2, true, 0);
	return;
}
	...
	switch (iParam0)
	{
		...
		case 5:
			*uParam1 = Global_113969.f_2366.f_539.f_2310[0];
			TEXT_LABEL_ASSIGN_STRING(sParam2, func_53(Global_113969.f_2366.f_539.f_2314[0]), 32);
			return true;
	
		case 6:
			*uParam1 = Global_113969.f_2366.f_539.f_2310[1];
			TEXT_LABEL_ASSIGN_STRING(sParam2, func_53(Global_113969.f_2366.f_539.f_2314[1]), 32);
			return true;
	
		case 7:
			*uParam1 = Global_113969.f_2366.f_539.f_2310[2];
			TEXT_LABEL_ASSIGN_STRING(sParam2, func_53(Global_113969.f_2366.f_539.f_2314[2]), 32);
			return true;
