...
struct<2> func_241(int iParam0, int iParam1, int iParam2) // Position - 0x27D6B Hash - 0x17D4C22E ^0x17D4C22E
{
	var unk;
	int num;
...
char* func_242(int iParam0) // Position - 0x27E41 Hash - 0xE6862179 ^0xD495D1A5
{
	switch (iParam0)
	{
		case 0:
