...
{
	func_215(uParam0, 145 /*_CHAR_NULL*/, sParam1, iParam5, iParam6, 0);
...
BOOL func_266(var uParam0) // Position - 0x102CC Hash - 0x12E9B767 ^0x292FB081
{
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			{
				uParam0->f_28[0] = PED::CREATE_PED(5 /*PED_TYPE_CIVFEMALE*/, joaat("IG_Tonya"), -16.53f, -1473.12f, 29.61f, 319.56f, true, true);
				...
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]))
				{
					...
					PED::SET_PED_COMPONENT_VARIATION(uParam0->f_28[0], 0 /*PV_COMP_HEAD*/, 0, 0, 0);
					PED::SET_PED_COMPONENT_VARIATION(uParam0->f_28[0], 2 /*PV_COMP_HAIR*/, 0, 0, 0);
					...
					PED::SET_PED_COMPONENT_VARIATION(uParam0->f_28[0], 8 /*PV_COMP_ACCS*/, 0, 0, 0);
				}
				else
				{
					flag = false;
