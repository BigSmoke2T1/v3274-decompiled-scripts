...
int func_32(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10) // Position - 0x154E Hash - 0x7F671285 ^0x7F671285
{
	...
	if (Global_113969.f_7691.f_764 < 8 /*CHAR_MIKE_FRANK_CONF*/)
	{
		...
		func_33(0 /*CHAR_MICHAEL*/);
		func_33(1 /*CHAR_FRANKLIN*/);
		func_33(2 /*CHAR_TREVOR*/);
		return 1;
	}
...
int func_41(eCharacter echParam0) // Position - 0x1BD7 Hash - 0x523E24 ^0x941A30AC
{
	eCharacter character;
...
void func_42(eCharacter echParam0, eCharacter echParam1) // Position - 0x1C2D Hash - 0xB539F413 ^0x1156AFD6
{
	eCharacter character;
...
BOOL func_57() // Position - 0x2186 Hash - 0x1F5F7ECA ^0xD8269CA6
{
	...
	else
	{
		...
		{
			pedLocal_48 = PED::CREATE_PED(26 /*PED_TYPE_MISSION*/, joaat("U_M_M_StreetArt_01"), uLocal_49, fLocal_52, true, true);
...
void func_72() // Position - 0x28C2 Hash - 0x140BEF68 ^0xB297BAF
{
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(pedLocal_48))
	{
		...
		switch (iLocal_53)
		{
			...
			case 1:
				if (func_83(joaat("SCRIPT_TASK_PLAY_ANIM") /*SCRIPT_TASK_PLAY_ANIM*/))
					iLocal_53 = 5;
			...
			case 2:
				if (func_83(joaat("SCRIPT_TASK_PERFORM_SEQUENCE") /*SCRIPT_TASK_PERFORM_SEQUENCE*/))
					iLocal_53 = 5;
...
{
	if (!func_84(pedLocal_48, esthParam0) && !func_84(pedLocal_48, joaat("SCRIPT_TASK_SMART_FLEE_PED") /*SCRIPT_TASK_SMART_FLEE_PED*/))
	{
		func_76(&blLocal_55);
