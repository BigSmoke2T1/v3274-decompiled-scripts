							...
							case 0:
								...
								else
								{
									...
									if (func_170())
									{
										func_163(true);
										SYSTEM::SETTIMERA(0);
										EVENT::ADD_SHOCKING_EVENT_AT_POSITION(90 /*EVENT_SHOCKING_GUN_FIGHT*/, uLocal_192, 15000f);
										iLocal_44 = 1;
									}
								}
								break;
								...
								switch (iLocal_45)
								{
									...
									case 2:
										...
										if (iLocal_47 == 1)
										{
											...
											if (func_114() && !bLocal_160)
											{
												...
												{
													PED::SET_PED_COMBAT_ATTRIBUTES(pedLocal_182, 17 /*BF_AlwaysFlee*/, true);
													PED::SET_PED_COMBAT_ATTRIBUTES(pedLocal_182, 6 /*BF_0x66BB9FCC*/, true);
													PED::SET_PED_COMBAT_ATTRIBUTES(pedLocal_182, 1 /*BF_CanUseVehicles*/, true);
									...
									case 10:
										...
										if (iLocal_47 == 1)
										{
											...
											func_75(6 /*CHAR_LEST_FRANK_CONF*/, 3);
											func_75(7 /*CHAR_LEST_MIKE_CONF*/, 3);
										}
										else if (iLocal_47 == 2)
										{
											if (!bLocal_158)
...
void func_1() // Position - 0x122B Hash - 0xB85412F8 ^0xAA1AE305
{
	...
	if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_214) > fLocal_215 && bLocal_181)
	{
		...
		func_141(false, true, true, false, false, false, false);
		PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), true, 4 /*SPC_CLEAR_TASKS*/);
		HUD::DISPLAY_HUD(true);
		HUD::DISPLAY_RADAR(true);
...
void func_4(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x16EA Hash - 0x99A9B13C ^0x970C9246
{
	Hash statName;
...
int func_8(int iParam0, int iParam1) // Position - 0x176D Hash - 0x744E461C ^0x36023077
{
	Hash statHash;
	int outValue;
...
void func_44() // Position - 0x2EC3 Hash - 0xD1F2D853 ^0xF9F5FD4D
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_113969.f_2366.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_45(character) && !func_38(14) || Global_112917)
			{
				if (Global_113969.f_2366.f_539.f_4321 != character && func_45(Global_113969.f_2366.f_539.f_4321))
...
BOOL func_78() // Position - 0x4AAF Hash - 0x70B4A54B ^0xF137E5FF
{
...
int func_79(int iParam0) // Position - 0x4B2E Hash - 0x46546439 ^0x46546439
{
	eCharacter character;
...
BOOL func_80(eCharacter echParam0) // Position - 0x4D56 Hash - 0x5A075A23 ^0x27F6B86F
{
	Hash entityModel;
...
Vehicle func_81(Vehicle veParam0) // Position - 0x4DC2 Hash - 0xC9D82232 ^0xC9D82232
{
	return veParam0;
}

void func_82(int iParam0, var uParam1) // Position - 0x4DCC Hash - 0x45AE8BFD ^0xA0700457
{
	int num;
	int num2;
...
BOOL func_83(int iParam0) // Position - 0x5764 Hash - 0xDEE87AD1 ^0x5F1ACD39
{
	var unk;
	int doorState;
...
int func_84(int iParam0) // Position - 0x5798 Hash - 0x626AEC54 ^0xDB28E416
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 9) & 31;
}

int func_85() // Position - 0x57AB Hash - 0x9E44C35 ^0xB9993D58
{
	var unk;
...
void func_86(var uParam0, int iParam1) // Position - 0x57F1 Hash - 0x15B9927E ^0x4A4674
{
	if (iParam1 <= 0)
		return;
...
void func_87(var uParam0, int iParam1) // Position - 0x5877 Hash - 0x4C70B2C3 ^0x4C70B2C3
{
...
void func_88(var uParam0, int iParam1) // Position - 0x58AA Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
int func_89(int iParam0, int iParam1) // Position - 0x58FB Hash - 0xD3EBACB3 ^0xD3EBACB3
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_90(int iParam0) // Position - 0x599D Hash - 0xE1B0542C ^0x127A471E
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_91(BOOL bParam0, var uParam1, var uParam2) // Position - 0x59BF Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
int func_92(int iParam0) // Position - 0x59D6 Hash - 0x2D4DB85F ^0x2D4DB85F
{
	return iParam0 & 15;
}

void func_93(var uParam0, int iParam1) // Position - 0x59E3 Hash - 0x864304A8 ^0x1F5003E2
{
...
void func_94(var uParam0, int iParam1) // Position - 0x5A1D Hash - 0x76860AE7 ^0x32308FFF
{
...
void func_95(var uParam0, int iParam1) // Position - 0x5A58 Hash - 0xDB8A72C0 ^0x4F6D426D
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
struct<7> func_96(int iParam0) // Position - 0x5A94 Hash - 0xA6A81C3E ^0x591CC9FB
{
	var unk;
...
{
	func_132(uParam0, 145 /*_CHAR_NULL*/, sParam1, iParam4, iParam5, iParam6);
...
BOOL func_143(Player plParam0, int iParam1) // Position - 0x9AB5 Hash - 0x1A32E11A ^0x81C44B3D
{
	BOOL flag;
	...
	if (plParam0 == PLAYER::PLAYER_ID())
		flag = func_144(-1, false) == 8 /*CHAR_MIKE_FRANK_CONF*/;
	else
...
BOOL func_146(Player plParam0) // Position - 0x9B71 Hash - 0x68897CDD ^0x7A533860
{
			...
			else if (iLocal_47 == 2)
			{
				if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_214) > 0.453f)
				{
					...
					if (!PED::IS_PED_INJURED(iLocal_112[0]))
					{
						...
						PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_112[0], 17 /*BF_AlwaysFlee*/, true);
					...
					if (!PED::IS_PED_INJURED(iLocal_112[1]))
					{
						...
						PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_112[1], 17 /*BF_AlwaysFlee*/, true);
...
void func_159() // Position - 0xAB17 Hash - 0xE01E8871 ^0xA29663CA
{
	...
	else if (STREAMING::HAS_MODEL_LOADED(model))
	{
		...
		pedLocal_182 = PED::CREATE_PED_INSIDE_VEHICLE(veLocal_173, 26 /*PED_TYPE_MISSION*/, joaat("G_M_Y_Korean_01"), -1, true, true);
		...
		PED::SET_PED_COMBAT_ATTRIBUTES(pedLocal_182, 8 /*BF_0xB4A13A5A*/, false);
...
int func_163(BOOL bParam0) // Position - 0xADA7 Hash - 0x3A78A0E1 ^0x9F47D7B3
{
	if (func_164())
	{
		...
		if (bParam0 && func_62(Global_113958))
...
{
	switch (func_165(&Global_33008, 0, 5, false, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return true;
...
void func_175() // Position - 0xB6F4 Hash - 0xA8EF140B ^0x3EE97631
{
	if (!PED::IS_PED_INJURED(iLocal_115[1]))
	{
...
void func_176(Ped pedParam0, char* sParam1, char* sParam2, int iParam3, BOOL bParam4) // Position - 0xB777 Hash - 0x92183E0E ^0xCC1D3ECB
{
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0(int iParam0) // Position - 0xB791 Hash - 0xA17D549C ^0x33AFC766
{
	char* str;
...
void func_178() // Position - 0xB986 Hash - 0x9E80F1CB ^0xD46ACD76
{
	int i;
	...
	for (i = 0; i <= iLocal_109 - 1; i = i + 1)
	{
		iLocal_112[i] = PED::CREATE_PED(26 /*PED_TYPE_MISSION*/, hLocal_220, uLocal_53[i /*3*/], uLocal_60[i], true, true);
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_112[i], true);
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_112[i], hLocal_188);
		PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_112[i], 8 /*BF_0xB4A13A5A*/, false);
	...
	if (iLocal_47 == 1)
	{
		...
		{
			iLocal_115[i] = PED::CREATE_PED(26 /*PED_TYPE_MISSION*/, hLocal_217, uLocal_63[i /*3*/], uLocal_73[i], true, true);
			PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_115[i], 17 /*BF_AlwaysFlee*/, true);
		...
		iLocal_119[0] = PED::CREATE_PED(26 /*PED_TYPE_MISSION*/, hLocal_218, uLocal_77[0 /*3*/], uLocal_90[0], true, true);
		PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_119[0], 17 /*BF_AlwaysFlee*/, true);
		...
		for (i = 1; i <= 2; i = i + 1)
		{
			iLocal_119[i] = PED::CREATE_PED(26 /*PED_TYPE_MISSION*/, hLocal_219, uLocal_77[i /*3*/], uLocal_90[i], true, true);
			PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_119[i], 17 /*BF_AlwaysFlee*/, true);
		...
		PED::SET_PED_COMPONENT_VARIATION(iLocal_115[0], 0 /*PV_COMP_HEAD*/, 0, 0, 0);
		PED::SET_PED_COMPONENT_VARIATION(iLocal_115[0], 2 /*PV_COMP_HAIR*/, 1, 1, 0);
		PED::SET_PED_COMPONENT_VARIATION(iLocal_115[0], 3 /*PV_COMP_UPPR*/, 1, 0, 0);
		PED::SET_PED_COMPONENT_VARIATION(iLocal_115[0], 4 /*PV_COMP_LOWR*/, 0, 0, 0);
		PED::SET_PED_COMPONENT_VARIATION(iLocal_115[0], 5 /*PV_COMP_HAND*/, 0, 0, 0);
		...
		PED::SET_PED_COMPONENT_VARIATION(iLocal_115[1], 0 /*PV_COMP_HEAD*/, 1, 0, 0);
		PED::SET_PED_COMPONENT_VARIATION(iLocal_115[1], 2 /*PV_COMP_HAIR*/, 0, 0, 0);
		PED::SET_PED_COMPONENT_VARIATION(iLocal_115[1], 3 /*PV_COMP_UPPR*/, 0, 0, 0);
		PED::SET_PED_COMPONENT_VARIATION(iLocal_115[1], 4 /*PV_COMP_LOWR*/, 1, 2, 0);
		PED::SET_PED_COMPONENT_VARIATION(iLocal_115[1], 5 /*PV_COMP_HAND*/, 0, 0, 0);
		TASK::TASK_COWER(iLocal_115[1], -1);
		PED::SET_PED_KEEP_TASK(iLocal_115[1], true);
		PED::SET_PED_COMPONENT_VARIATION(iLocal_115[2], 0 /*PV_COMP_HEAD*/, 1, 0, 0);
		PED::SET_PED_COMPONENT_VARIATION(iLocal_115[2], 2 /*PV_COMP_HAIR*/, 1, 0, 0);
		PED::SET_PED_COMPONENT_VARIATION(iLocal_115[2], 3 /*PV_COMP_UPPR*/, 0, 2, 0);
		PED::SET_PED_COMPONENT_VARIATION(iLocal_115[2], 4 /*PV_COMP_LOWR*/, 1, 2, 0);
		PED::SET_PED_COMPONENT_VARIATION(iLocal_115[2], 5 /*PV_COMP_HAND*/, 0, 0, 0);
		...
		PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_214, true);
		PED::SET_PED_COMPONENT_VARIATION(iLocal_119[0], 0 /*PV_COMP_HEAD*/, 0, 1, 0);
		PED::SET_PED_COMPONENT_VARIATION(iLocal_119[0], 2 /*PV_COMP_HAIR*/, 0, 0, 0);
		PED::SET_PED_COMPONENT_VARIATION(iLocal_119[0], 3 /*PV_COMP_UPPR*/, 0, 1, 0);
		PED::SET_PED_COMPONENT_VARIATION(iLocal_119[0], 4 /*PV_COMP_LOWR*/, 0, 1, 0);
		PED::SET_PED_COMPONENT_VARIATION(iLocal_119[0], 8 /*PV_COMP_ACCS*/, 0, 0, 0);
		...
		PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_214, true);
		PED::SET_PED_COMPONENT_VARIATION(iLocal_119[1], 0 /*PV_COMP_HEAD*/, 0, 0, 0);
		PED::SET_PED_COMPONENT_VARIATION(iLocal_119[1], 2 /*PV_COMP_HAIR*/, 0, 1, 0);
		PED::SET_PED_COMPONENT_VARIATION(iLocal_119[1], 3 /*PV_COMP_UPPR*/, 1, 1, 0);
		PED::SET_PED_COMPONENT_VARIATION(iLocal_119[1], 4 /*PV_COMP_LOWR*/, 1, 1, 0);
		PED::SET_PED_COMPONENT_VARIATION(iLocal_119[1], 8 /*PV_COMP_ACCS*/, 0, 0, 0);
		...
		PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_214, true);
		PED::SET_PED_COMPONENT_VARIATION(iLocal_119[2], 0 /*PV_COMP_HEAD*/, 1, 0, 0);
		PED::SET_PED_COMPONENT_VARIATION(iLocal_119[2], 2 /*PV_COMP_HAIR*/, 0, 2, 0);
		PED::SET_PED_COMPONENT_VARIATION(iLocal_119[2], 3 /*PV_COMP_UPPR*/, 0, 1, 0);
		PED::SET_PED_COMPONENT_VARIATION(iLocal_119[2], 4 /*PV_COMP_LOWR*/, 1, 0, 0);
		PED::SET_PED_COMPONENT_VARIATION(iLocal_119[2], 8 /*PV_COMP_ACCS*/, 0, 0, 0);
	...
	else if (iLocal_47 == 2)
	{
		...
		iLocal_115[0] = PED::CREATE_PED(26 /*PED_TYPE_MISSION*/, hLocal_217, uLocal_63[0 /*3*/], uLocal_73[0], true, true);
		PED::SET_PED_NAME_DEBUG(iLocal_115[0], "pedWorker[0]");
		...
		iLocal_115[1] = PED::CREATE_PED(26 /*PED_TYPE_MISSION*/, hLocal_216, uLocal_63[1 /*3*/], uLocal_73[1], true, true);
		PED::SET_PED_NAME_DEBUG(iLocal_115[1], "pedWorker[1]");
		...
		iLocal_119[0] = PED::CREATE_PED(26 /*PED_TYPE_MISSION*/, hLocal_218, uLocal_77[0 /*3*/], uLocal_90[0], true, true);
		PED::SET_PED_NAME_DEBUG(iLocal_119[0], "pedShopper[0]");
		iLocal_119[1] = PED::CREATE_PED(26 /*PED_TYPE_MISSION*/, hLocal_219, uLocal_77[1 /*3*/], uLocal_90[1], true, true);
		PED::SET_PED_NAME_DEBUG(iLocal_119[1], "pedShopper[1]");
...
void func_179(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0xC3DB Hash - 0x2075EA50 ^0x1095295C
{
	int num;
	eCharacter character;
...
eCharacter func_180(int iParam0, int iParam1) // Position - 0xC448 Hash - 0x8DB675F0 ^0x8DB675F0
{
	switch (iParam0)
	{
		case 0:
...
void func_181(int iParam0) // Position - 0xC8C9 Hash - 0xD221ACEF ^0xD221ACEF
{
	func_11(iParam0, 9, true);
	return;
}

void func_182(int iParam0, BOOL bParam1) // Position - 0xC8DA Hash - 0x6BA7E188 ^0x6BA7E188
{
	if (bParam1)
	{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xC918 Hash - 0x6C235EE0 ^0x9E57F206
{
...
void func_184() // Position - 0xC9B3 Hash - 0x52AC390D ^0xA895776A
{
	if (!bLocal_133)
	{
...
void func_185() // Position - 0xC9D7 Hash - 0xCE5884D7 ^0x9D30AEAF
{
...
void func_186() // Position - 0xCAFC Hash - 0x2E9C5D72 ^0xA41ABD97
{
	uLocal_139[0] = 0;
	uLocal_139[1] = 0;
...
BOOL func_187() // Position - 0xCDDB Hash - 0xC05B0E62 ^0x94C54EFE
{
...
int func_188(float fParam0, BOOL bParam1) // Position - 0xCE61 Hash - 0xA169FFDC ^0x284941E0
{
	var unk;
	int num;
	int num2;
...
void func_189(int iParam0, var uParam1) // Position - 0xCF12 Hash - 0x2D8E3F8 ^0x97E69E0D
{
	switch (iParam0)
	{
		case 0:
...
int func_191(int iParam0) // Position - 0xE1EA Hash - 0xC999F6B2 ^0xC999F6B2
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_192(int iParam0) // Position - 0xE530 Hash - 0x323E6781 ^0x3EB0F2C2
{
	var unk;
	var unk3;
...
struct<2> func_193(int iParam0) // Position - 0xE568 Hash - 0x975AC8C9 ^0xDFF17845
{
	var unk;
...
BOOL func_194() // Position - 0xE9B5 Hash - 0x7055FFB1 ^0x7055FFB1
{
...
BOOL func_195() // Position - 0xE9E7 Hash - 0x79CF7679 ^0x79CF7679
{
	return Global_113687 > 0;
}

BOOL func_196() // Position - 0xE9F5 Hash - 0xCF2296C0 ^0xCF2296C0
{
	if (Global_98435 != -1)
		return true;
...
BOOL func_197() // Position - 0xEA0A Hash - 0x98CCC132 ^0x97B0D6ED
{
	if (Global_98435 != -1)
...
BOOL func_198() // Position - 0xEA2D Hash - 0x29CB2928 ^0xE369A18D
{
	if (MISC::IS_PC_VERSION())
...
BOOL func_199() // Position - 0xEA4A Hash - 0xF2B7F534 ^0x7F3EC4F9
{
...
BOOL func_200() // Position - 0xEAAC Hash - 0x1121F6F2 ^0x90CE37A6
{
...
void func_201(int iParam0) // Position - 0xEAD7 Hash - 0xA62BD46A ^0x1E050688
{
	if (iParam0 == -1)
		iParam0 = func_71();
...
void func_202() // Position - 0xEB0D Hash - 0x178BF2A7 ^0x744062F5
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
...
void func_203(int iParam0) // Position - 0xEB4A Hash - 0xE49C42EC ^0xE49C42EC
{
	Global_113958 = iParam0;
	return;
}

BOOL func_204(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xEB58 Hash - 0xC601B4EA ^0xC601B4EA
{
	BOOL flag;
	Vector3 entityCoords;
	eCharacter i;
...
BOOL func_205(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0xEEF2 Hash - 0x2D46096D ^0xEA41378F
{
	if (bParam6)
...
BOOL func_206(eCharacter echParam0) // Position - 0xEF39 Hash - 0x687D9246 ^0x687D9246
{
	int num;
...
BOOL func_207(int iParam0) // Position - 0xEF5A Hash - 0x2D75E13A ^0x2D75E13A
{
	return func_208(iParam0, 1);
}

int func_208(int iParam0, int iParam1) // Position - 0xEF69 Hash - 0x1F92FEBC ^0x1F92FEBC
{
	var unk;
	var unk2;
	int num;
...
void func_209(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0xEFBC Hash - 0x2BEE335D ^0x2BEE335D
{
	func_210(func_85(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
	return;
}

void func_210(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0xEFDA Hash - 0xB807819C ^0xB807819C
{
	int num;
	int num2;
	int num3;
...
float func_211(float fParam0, float fParam1, float fParam2) // Position - 0xF1DB Hash - 0xDB08F514 ^0x78C0BF6F
{
	float num;
...
int func_212(int iParam0) // Position - 0xF21D Hash - 0x90B520AB ^0x257AC1C4
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 20) & 63;
}

int func_213(int iParam0) // Position - 0xF230 Hash - 0xC188C91C ^0x48884C7
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 14) & 63;
}

int func_214(int iParam0) // Position - 0xF243 Hash - 0x826C592F ^0xDEC5AA46
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 4) & 31;
}

BOOL func_215(int iParam0, int iParam1) // Position - 0xF255 Hash - 0xEA08B1 ^0xEA08B1
{
	int num;
	int num2;
...
BOOL func_216(int iParam0) // Position - 0xF361 Hash - 0x57D8E518 ^0xD297DD35
{
	int num;
	int num2;
	int num3;
...
BOOL func_217(int iParam0, int iParam1) // Position - 0xF43D Hash - 0x577FB514 ^0xAAF8B538
{
...
BOOL func_218(int iParam0) // Position - 0xF45D Hash - 0x97844555 ^0xADCD6DAA
{
	eCharacter character;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_226() || Global_113016 || Global_32951 || func_225() || func_130(8, -1) || func_224() || func_223() || func_222() || func_221() || Global_113969.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_226() || Global_32951 || func_225() || func_130(8, -1) || func_222() || func_224() || func_223() || func_221() || Global_113969.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_226() || Global_113016 || Global_32951 || func_225() || func_130(8, -1) || func_222() || func_224() || func_223() || func_221() || Global_113969.f_7691.f_919[character] == 5 || Global_44589 != -1)
							return false;
						break;
				
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_226() || Global_113016 || Global_32951 || func_225() || func_130(8, -1) || func_224() || func_223() || func_221() || Global_113969.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_226() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_130(8, -1) || func_221() || func_220() || Global_113969.f_7691.f_919[character] == 5)
							return false;
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
							if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_226() || Global_32951 || func_225() || func_130(8, -1) || func_223() || func_222() || func_221() || Global_113969.f_7691.f_919[character] == 5)
								return false;
						break;
				
					case 7:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_226() || func_223() || Global_113016 || Global_32951 || func_225() || Global_45250 || func_130(8, -1) || func_222() || func_220() || func_221() || Global_113969.f_7691.f_919[character] == 5)
							return false;
						break;
...
BOOL func_219() // Position - 0xFB7A Hash - 0x4228A1C2 ^0x952FE30F
{
	return Global_101572.f_1;
}

BOOL func_220() // Position - 0xFB88 Hash - 0xC20DBA70 ^0xAC4006FB
{
	if (Global_98435 != -1)
...
BOOL func_221() // Position - 0xFBAB Hash - 0x3CA1BB47 ^0xB78A1ACB
{
...
BOOL func_222() // Position - 0xFBC5 Hash - 0xE663B8F6 ^0xE663B8F6
{
	if (Global_79650)
		return true;
...
BOOL func_223() // Position - 0xFBEF Hash - 0xD56328D2 ^0xD56328D2
{
	return Global_101585.f_394 > 0;
}

BOOL func_224() // Position - 0xFC00 Hash - 0xD56328D2 ^0xD56328D2
{
	return Global_101585.f_393 > 0;
}

BOOL func_225() // Position - 0xFC11 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1575083;
}

BOOL func_226() // Position - 0xFC1D Hash - 0x7FE517FE ^0x128A3BC8
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
BOOL func_227() // Position - 0xFC39 Hash - 0xB12DEAA2 ^0xB12DEAA2
{
	_UPDATE_CURRENT_PLAYER_CHARACTER();
...
BOOL func_228(int iParam0) // Position - 0xFC61 Hash - 0xCDB90269 ^0xCDB90269
{
	return func_215(func_85(), iParam0);
}

BOOL func_229(int iParam0, int iParam1, eCharacter echParam2) // Position - 0xFC73 Hash - 0xBEEFD79C ^0xBEEFD79C
{
	BOOL num;
	eCharacter character;
...
int func_230(eCharacter echParam0) // Position - 0xFD57 Hash - 0x45FC9D61 ^0x45FC9D61
{
...
BOOL func_231(int iParam0) // Position - 0xFD7B Hash - 0xF2A54181 ^0xF2A54181
{
	int num;
	BOOL flag;
...
BOOL func_232() // Position - 0xFDD3 Hash - 0xB72C022E ^0x452A7B6D
{
	Vehicle vehiclePedIsIn;
...
BOOL _IS_EXCLUSIVE_CONTENT_UNLOCKED() // Position - 0xFE17 Hash - 0x44DD83CC ^0x7B62A376
{
	int profileSetting;
...
BOOL func_234(int iParam0) // Position - 0xFECF Hash - 0xA85A6891 ^0xA85A6891
{
	return func_12(iParam0, 0, false);
}

BOOL func_235(int iParam0) // Position - 0xFEDF Hash - 0x12F39C08 ^0x12F39C08
{
	return func_12(iParam0, 7, true);
}

void func_236() // Position - 0xFEEF Hash - 0xE9E71D13 ^0x2FEBCC93
{
	int i;
...
void func_237(int iParam0) // Position - 0x10242 Hash - 0xE6B11918 ^0x37AF2AD2
{
	var name;
...
void func_238(var uParam0) // Position - 0x102F4 Hash - 0x995C9E2 ^0x995C9E2
{
	if (*uParam0 == -1)
		return;
...
char* func_239(int iParam0, BOOL bParam1) // Position - 0x10331 Hash - 0x959319CB ^0x7C424BE
{
	switch (iParam0)
	{
		case 0:
...
void func_240(int iParam0) // Position - 0x1057A Hash - 0xC0234809 ^0x4FD853DC
{
	Global_44593 = MISC::GET_GAME_TIMER() + iParam0;
	return;
}

void func_241(int iParam0) // Position - 0x1058C Hash - 0x881273A8 ^0x881273A8
{
	func_242(iParam0, 0, func_247(iParam0));
	return;
}

void func_242(int iParam0, int iParam1, int iParam2) // Position - 0x105A1 Hash - 0xA7DBC311 ^0xA7DBC311
{
	int num;
	var unk;
...
struct<16> func_243(var uParam0) // Position - 0x105D0 Hash - 0xB96DB942 ^0x5E1CC59
{
	var unk;
	int num;
...
void func_244(int iParam0, var uParam1) // Position - 0x106A1 Hash - 0x63EF72B0 ^0xC612AA53
{
	Global_113969.f_24998.f_43[iParam0] = *uParam1;
	return;
}

void func_245(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x106B9 Hash - 0xB28A4507 ^0xB28A4507
{
	int num;
	int i;
	int num2;
...
void func_246(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x1083B Hash - 0x733BFBA2 ^0x733BFBA2
{
...
int func_247(int iParam0) // Position - 0x10873 Hash - 0x4219564C ^0x4219564C
{
	int num;
...
void func_248() // Position - 0x10A16 Hash - 0xC536DD5 ^0xC536DD5
{
	Global_21152 = 0;
	func_249();
	return;
...
void func_249() // Position - 0x10A26 Hash - 0x21027D29 ^0xBEB9ECFD
{
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
	{
		AUDIO::RESTART_SCRIPTED_CONVERSATION();
...
Vector3 func_250() // Position - 0x10A4A Hash - 0x6E882E8A ^0x7CC5616F
{
	float distanceBetweenCoords;
