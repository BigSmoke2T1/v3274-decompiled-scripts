...
void func_32() // Position - 0xBFA Hash - 0x46DD98A9 ^0xA3EB7992
{
	switch (iLocal_61)
	{
		...
		case 5:
			...
			if (!PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()) || func_28() || func_34() || func_33(true) || PAD::IS_DISABLED_CONTROL_JUST_PRESSED(2 /*FRONTEND_CONTROL*/, 37 /*INPUT_SELECT_WEAPON*/) || PAD::IS_DISABLED_CONTROL_JUST_PRESSED(2 /*FRONTEND_CONTROL*/, 19 /*INPUT_CHARACTER_WHEEL*/) || func_27(23) || func_27(21) || func_27(16))
				iLocal_61 = 9;
			break;
		...
		case 4:
			if (func_38(1000, iLocal_70))
			{
				...
				if (_GET_CURRENT_PLAYER_CHARACTER() == 0 /*CHAR_MICHAEL*/)
					PED::SET_PED_COMPONENT_VARIATION(PLAYER::PLAYER_PED_ID(), 9 /*PV_COMP_TASK*/, 0, 0, 0);
				else
					PED::SET_PED_COMPONENT_VARIATION(PLAYER::PLAYER_PED_ID(), 8 /*PV_COMP_ACCS*/, 0, 0, 0);
...
int func_60(Ped pedParam0) // Position - 0x19B7 Hash - 0x51C93D7B ^0xC3903426
{
	return func_61(pedParam0, -1, true, -1082130432);
}

int func_61(Ped pedParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x19CC Hash - 0x49540C89 ^0xE4E98DF3
{
	int num;
	int num2;
	int num3;
...
int func_62() // Position - 0x1A93 Hash - 0x412B82DF ^0x412B82DF
{
	int i;
...
int func_63(Ped pedParam0) // Position - 0x1AC2 Hash - 0x219FA119 ^0x5240A8AF
{
	int i;
...
void func_64() // Position - 0x1B03 Hash - 0x6D98E4D5 ^0xF8371B8B
{
	switch (iLocal_56)
	{
		case 1:
...
void func_65() // Position - 0x1BAA Hash - 0xB0AFB7D6 ^0x2AAA98
{
	switch (iLocal_59)
	{
		case 1:
...
BOOL func_66(int iParam0) // Position - 0x1C75 Hash - 0x71C4CD2D ^0x71C4CD2D
{
...
void func_67() // Position - 0x1C8B Hash - 0x911CD778 ^0x7F0CC78E
{
...
void func_68() // Position - 0x1CC8 Hash - 0xEAA42EA5 ^0xEAA42EA5
{
	func_87();
	func_81();
	func_80();
...
void func_69() // Position - 0x1CFC Hash - 0x86B88893 ^0xD2C00E78
{
	if (iLocal_55 == 4)
	{
		iLocal_55 = 1;
...
BOOL func_70() // Position - 0x1D74 Hash - 0xFB608F6D ^0xFB608F6D
{
	if (bLocal_91)
	{
		bLocal_91 = false;
...
BOOL func_71(int iParam0) // Position - 0x1D95 Hash - 0xE8921B44 ^0x4F063755
{
	if (iParam0 == 1)
...
void func_72() // Position - 0x1DEC Hash - 0xD7B44821 ^0x1F455956
{
...
void func_73() // Position - 0x1E8F Hash - 0xF4DC488E ^0xE400B8EF
{
	int playerWantedLevel;
...
void func_74() // Position - 0x1F3E Hash - 0x183CD44E ^0xC6CB930B
{
	if (iLocal_52 == 4)
	{
		iLocal_52 = 1;
...
Hash func_75() // Position - 0x1FE5 Hash - 0xDED80B4D ^0x529AE3F0
{
	return ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID());
}

void func_76() // Position - 0x1FF5 Hash - 0xEFCBE973 ^0xEC5D1C0F
{
...
void func_77() // Position - 0x20CE Hash - 0x95319A5F ^0x50DFDED0
{
	if (iLocal_50 == 4)
	{
		iLocal_50 = 1;
...
void func_78() // Position - 0x225D Hash - 0x9B136050 ^0x91425887
{
	if (iLocal_49 == 4)
	{
		iLocal_49 = 1;
...
void func_79() // Position - 0x2332 Hash - 0x46D94DA5 ^0xA9FF5F91
{
	switch (iLocal_48)
	{
		case 1:
...
void func_80() // Position - 0x23DA Hash - 0x30ACA5DE ^0xB043F2E5
{
	switch (iLocal_47)
	{
		case 1:
...
void func_81() // Position - 0x24C3 Hash - 0x31F6A94F ^0x51163FE6
{
...
BOOL func_82(int iParam0) // Position - 0x25EA Hash - 0x6EE24E46 ^0x73B48A59
{
...
BOOL func_83(Vehicle veParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x27EB Hash - 0xBCC62924 ^0x77695844
{
	int i;
	var garageName;
	int num;
...
BOOL func_84(eCharacter echParam0, int iParam1, char* sParam2, var uParam3) // Position - 0x2859 Hash - 0xF34BEAE8 ^0xBC089CB
{
...
Hash func_85(eCharacter echParam0, int iParam1) // Position - 0x2931 Hash - 0x3C1119CD ^0x1010ECAE
{
	Hash num;
...
void func_86(eCharacter echParam0, var uParam1, int iParam2) // Position - 0x2973 Hash - 0xF92B8944 ^0xD11BCD5C
{
	int num;
...
void func_87() // Position - 0x2BCF Hash - 0xCFA276E4 ^0x679871EF
{
	switch (iLocal_45)
	{
		case 1:
...
void func_88() // Position - 0x2C78 Hash - 0x83B715C3 ^0x48ACF6CB
{
...
void func_89() // Position - 0x33DC Hash - 0x51167D4C ^0x7C87C80F
{
	if (func_28())
	{
...
void func_90() // Position - 0x3448 Hash - 0xA15240F9 ^0xE7C46A3A
{
	if (func_28())
	{
		func_21("CHEAT_MISSION_DENIED" /*Not available on a mission or pastime.*/);
...
void func_91() // Position - 0x34BF Hash - 0x304EA65C ^0x112E6204
{
	if (func_28())
	{
		func_21("CHEAT_MISSION_DENIED" /*Not available on a mission or pastime.*/);
...
void func_92() // Position - 0x3598 Hash - 0x51167D4C ^0x7C87C80F
{
	if (func_28())
	{
		func_21("CHEAT_MISSION_DENIED" /*Not available on a mission or pastime.*/);
...
void func_93() // Position - 0x3604 Hash - 0x20C9DA12 ^0x4D621459
{
	var unk;
...
void func_94() // Position - 0x368E Hash - 0xC9A58B02 ^0x68FA13D3
{
	if (func_28())
	{
		func_21("CHEAT_MISSION_DENIED" /*Not available on a mission or pastime.*/);
...
void func_95() // Position - 0x3703 Hash - 0x6AC820C8 ^0xD01363B2
{
	if (func_28())
	{
		func_21("CHEAT_MISSION_DENIED" /*Not available on a mission or pastime.*/);
...
void func_96() // Position - 0x377A Hash - 0xE0263E8E ^0xDBA2D302
{
	if (func_28())
	{
		func_21("CHEAT_MISSION_DENIED" /*Not available on a mission or pastime.*/);
...
void func_97() // Position - 0x37F1 Hash - 0xD68DE57B ^0xC16845DC
{
	if (func_28())
	{
		func_21("CHEAT_MISSION_DENIED" /*Not available on a mission or pastime.*/);
...
void func_98() // Position - 0x3868 Hash - 0x27A40C71 ^0x918C4C18
{
...
void func_99() // Position - 0x38DB Hash - 0x205D9171 ^0x9674975C
{
...
void func_100() // Position - 0x394E Hash - 0x5BC5EF35 ^0xC9FA2135
{
...
void func_101() // Position - 0x39A9 Hash - 0x6E016A80 ^0x5BD726D4
{
...
BOOL _IS_EXCLUSIVE_CONTENT_UNLOCKED() // Position - 0x3A0E Hash - 0x44DD83CC ^0x7B62A376
{
	int profileSetting;
...
void func_103(int iParam0, char* sParam1) // Position - 0x3AC6 Hash - 0x90587053 ^0x699DED6F
{
	if (iLocal_44 == 1)
	{
...
BOOL func_104(int iParam0) // Position - 0x3B60 Hash - 0xC78E8C7 ^0xC78E8C7
{
	switch (iParam0)
	{
		case joaat("dodo"):
...
BOOL func_105(int iParam0, int iParam1) // Position - 0x3BB8 Hash - 0x9EA0654 ^0x9EA0654
{
	if (iParam0 == -1)
		return false;
...
BOOL func_106(int iParam0, int iParam1) // Position - 0x3BD8 Hash - 0xBAAAA77A ^0x16DDA499
{
...
BOOL func_107(Hash hParam0, int iParam1) // Position - 0x3C22 Hash - 0x87CFC258 ^0xE45D0F96
{
	if (!func_15(14))
...
void func_108() // Position - 0x3C40 Hash - 0x2A596865 ^0xEB523C98
{
	int i;
...
BOOL func_109() // Position - 0x3C76 Hash - 0x25806CBF ^0x25806CBF
{
...
void func_110() // Position - 0x3CB4 Hash - 0x880D0B8B ^0xFA6B476C
{
...
BOOL func_111() // Position - 0x3CFF Hash - 0xE663B8F6 ^0xE663B8F6
{
	if (Global_79650)
		return true;
...
void func_112() // Position - 0x3D29 Hash - 0xE91C327D ^0xE91C327D
{
	int i;
...
void func_113() // Position - 0x3D51 Hash - 0x49880A15 ^0x75F8A7C1
{
