...
void main() // Position - 0x0 Hash - 0x5D84F89F ^0x5D84F89F
{
	...
	iLocal_90 = func_332(64 /*CHAR_NIGEL*/);
...
int func_49(int iParam0, int iParam1) // Position - 0x39DB Hash - 0x744E461C ^0x36023077
{
	Hash statHash;
	int outValue;
...
Hash func_64(Hash hParam0, int iParam1) // Position - 0x4955 Hash - 0x6010BC66 ^0x1DFF9FB7
{
	int num;
	int dlcWeaponIndex;
	int i;
...
int func_65(Hash hParam0, Any* panParam1) // Position - 0x5696 Hash - 0x539D27DB ^0xB7B7AD25
{
	int i;
	int numDlcWeapons;
...
Hash func_66(int iParam0) // Position - 0x56D1 Hash - 0x5FB59AC3 ^0x9BC6B2ED
{
	int num;
...
void func_67(Ped pedParam0) // Position - 0x5945 Hash - 0x27D5295B ^0xD1A82444
{
	eCharacter character;
...
void func_68(var uParam0, int iParam1) // Position - 0x5981 Hash - 0x635FFA34 ^0xAE461588
{
	var unk;
	var unk2;
	var unk5;
...
BOOL func_69(Vector3 vParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5ED0 Hash - 0xA7FD254F ^0xFF9CDA51
{
...
BOOL func_70(int iParam0, var uParam1, var uParam2) // Position - 0x5F14 Hash - 0xE3586C79 ^0xE3586C79
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
...
BOOL func_71(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x6693 Hash - 0x2D46096D ^0xEA41378F
{
	if (bParam6)
...
BOOL func_72(var uParam0) // Position - 0x66DA Hash - 0xDB33C708 ^0xF5B91AC7
{
...
BOOL func_73(int iParam0) // Position - 0x6735 Hash - 0xCAEAF99E ^0xCAEAF99E
{
	return func_74(iParam0, 0, true);
}

BOOL func_74(int iParam0, int iParam1, BOOL bParam2) // Position - 0x6745 Hash - 0xA45BEB30 ^0x6033D2A2
{
	if (iParam0 == -1)
		return false;
...
int func_75(int iParam0) // Position - 0x67A5 Hash - 0x28E83966 ^0x9E37924F
{
	switch (iParam0)
	{
		case 0:
...
int func_76() // Position - 0x6B4D Hash - 0x21D64237 ^0x21D64237
{
	return Global_32948;
}

BOOL func_77(int iParam0) // Position - 0x6B58 Hash - 0xBE61F0FD ^0xBE61F0FD
{
	return func_74(iParam0, 5, true);
}

int func_78(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6B68 Hash - 0x4E8D2C12 ^0x4E8D2C12
{
	int i;
...
Vector3 func_79(int iParam0, BOOL bParam1) // Position - 0x6C0A Hash - 0x4894642D ^0x4894642D
{
	switch (iParam0)
	{
		case -1:
...
Vector3 func_80() // Position - 0x7369 Hash - 0x6E37375C ^0x6E37375C
{
...
int func_81() // Position - 0x7664 Hash - 0x974E48B4 ^0x974E48B4
{
	return Global_2652592.f_2671;
}

BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x7673 Hash - 0x16E871AD ^0x10C54C39
{
...
ePedComponentType func_83() // Position - 0x769D Hash - 0xEAE183ED ^0x84867848
{
	return Global_2657971[PLAYER::PLAYER_ID() /*465*/].f_322.f_8;
}

Vector3 func_84(float fParam0, float fParam1, float fParam2) // Position - 0x76B5 Hash - 0xD52A1F8B ^0x5D514503
{
	return OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(func_85(), 0f, fParam0);
}

Vector3 func_85() // Position - 0x76CA Hash - 0x21158019 ^0x21158019
{
	return -880f, -2770f, -50f;
}

BOOL func_86(ePedComponentType epctParam0) // Position - 0x76E1 Hash - 0x78AB9EAC ^0x78AB9EAC
{
...
Vector3 func_87(int iParam0, int iParam1) // Position - 0x7739 Hash - 0x7E203DFC ^0x7E203DFC
{
	var unk;
	var unk7;
...
BOOL func_88(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x77E3 Hash - 0x5642A5C0 ^0x5642A5C0
{
	var unk;
	Vector3 vector;
	var unk12;
...
Vector3 func_89(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x7878 Hash - 0x8959C4D1 ^0x8922A2E2
{
	float num;
	float num2;
	float num3;
...
struct<6> func_90(int iParam0) // Position - 0x78BC Hash - 0xC73C1158 ^0x2A6D4A6F
{
	var unk;
...
struct<6> func_91(int iParam0) // Position - 0x7A40 Hash - 0x2623C81B ^0x2623C81B
{
	return func_92(iParam0);
}

struct<6> func_92(int iParam0) // Position - 0x7A4E Hash - 0x7684F11 ^0xD37BE1E4
{
	var unk;
...
BOOL func_93(int iParam0, var uParam1) // Position - 0x8516 Hash - 0x31632D18 ^0xF002B35A
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_94(ePedComponentType epctParam0) // Position - 0x8598 Hash - 0x9D5E1610 ^0x9D5E1610
{
	if (epctParam0 != _INVALID_PLAYER_INDEX())
...
Player _INVALID_PLAYER_INDEX() // Position - 0x85F0 Hash - 0x478900E4 ^0x478900E4
{
	return -1;
}

Vector3 func_96(int iParam0) // Position - 0x85F9 Hash - 0xCBED323 ^0xCBED323
{
	switch (iParam0)
	{
		case 1:
...
int func_97() // Position - 0x8865 Hash - 0x5976C0FC ^0xC3C6644E
{
	return func_98(PLAYER::PLAYER_ID());
}

int func_98(Player plParam0) // Position - 0x8875 Hash - 0x1A54F100 ^0x35DB7B9D
{
	return MISC::GET_BITS_IN_RANGE(Global_2657971[plParam0 /*465*/].f_322.f_3, 28, 31);
}

BOOL func_99(int iParam0) // Position - 0x8892 Hash - 0xA85A6891 ^0xA85A6891
{
	return func_74(iParam0, 0, false);
}

int func_100(int iParam0) // Position - 0x88A2 Hash - 0x1BE0B176 ^0x1BE0B176
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_101() // Position - 0x8BD8 Hash - 0xD56328D2 ^0xD56328D2
{
	return Global_101585.f_393 > 0;
}

var func_102() // Position - 0x8BE9 Hash - 0x9E44C35 ^0xB9993D58
{
	var unk;
...
void func_103(var uParam0, int iParam1) // Position - 0x8C2F Hash - 0x15B9927E ^0x4A4674
{
	if (iParam1 <= 0)
		return;
...
void func_104(var uParam0, int iParam1) // Position - 0x8CB5 Hash - 0x4C70B2C3 ^0x4C70B2C3
{
...
void func_105(var uParam0, int iParam1) // Position - 0x8CE8 Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
int func_106(int iParam0, int iParam1) // Position - 0x8D39 Hash - 0xD3EBACB3 ^0xD3EBACB3
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_107(int iParam0) // Position - 0x8DDB Hash - 0xE1B0542C ^0x127A471E
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_108(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8DFD Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
int func_109(int iParam0) // Position - 0x8E14 Hash - 0x2D4DB85F ^0x2D4DB85F
{
	return iParam0 & 15;
}

void func_110(var uParam0, int iParam1) // Position - 0x8E21 Hash - 0x864304A8 ^0x1F5003E2
{
...
void func_111(var uParam0, int iParam1) // Position - 0x8E5B Hash - 0x76860AE7 ^0x32308FFF
{
...
void func_112(var uParam0, int iParam1) // Position - 0x8E96 Hash - 0xDB8A72C0 ^0x4F6D426D
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x8ED2 Hash - 0x3C5423D7 ^0x3C5423D7
{
	func_58();
	return Global_113969.f_2366.f_539.f_4321;
}

void func_114(int iParam0) // Position - 0x8EEB Hash - 0x35AC36F2 ^0x7E461E1E
{
	int num;
	var textLabel;
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x8F44 Hash - 0x4C81F065 ^0x79C65D03
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x8F5A Hash - 0x4C81F065 ^0xB17A9745
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_117(char* sParam0, Any anParam1, int iParam2) // Position - 0x8F70 Hash - 0x817AB180 ^0x792714F1
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x8FB2 Hash - 0x15889021 ^0xE7262364
{
...
struct<2> func_119(int iParam0) // Position - 0x8FDA Hash - 0x975AC8C9 ^0x4FD7D74D
{
	var unk;
...
void func_120(int iParam0, var uParam1) // Position - 0x9427 Hash - 0x2D8E3F8 ^0xCCC35382
{
	switch (iParam0)
	{
		case 0:
...
int func_122(int iParam0) // Position - 0xA6FF Hash - 0xC999F6B2 ^0xC999F6B2
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_123(Any* panParam0) // Position - 0xAA45 Hash - 0x1D39FD6 ^0xAFEDDB74
{
	int threadId;
...
void func_124(int iParam0) // Position - 0xAAEA Hash - 0xE0445FFC ^0x204FFA11
{
	var name;
...
void func_125(int iParam0) // Position - 0xAB85 Hash - 0xE70A4F17 ^0xE70A4F17
{
	if (iParam0 < 63)
	{
		func_126();
...
void func_126() // Position - 0xABAB Hash - 0xD5DFA716 ^0xD54995D4
{
	Global_79644 != 6;
...
void func_127(Ped pedParam0) // Position - 0xABE3 Hash - 0x91438920 ^0xDA692F14
{
	int num;
	int num2;
	int num3;
...
void func_128(int iParam0) // Position - 0xAC3C Hash - 0xBB510F32 ^0xE77AE77B
{
...
int func_129(Ped pedParam0) // Position - 0xACBF Hash - 0x14AF2EDD ^0xC5BC7CD2
{
	int i;
...
void func_130(int iParam0, int iParam1, int iParam2) // Position - 0xACF0 Hash - 0xF54D70EF ^0xF54D70EF
{
	func_131(iParam0, iParam1, iParam2, 0, 0, 1);
	return;
}

void func_131(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xAD05 Hash - 0x9F3D8BA2 ^0x9F3D8BA2
{
	int num;
...
int func_132() // Position - 0xAD87 Hash - 0x11506CC4 ^0x2E9F5641
{
	int i;
...
BOOL func_133(int iParam0, int iParam1, int iParam2) // Position - 0xADB8 Hash - 0x3A30B8C2 ^0x3A30B8C2
{
...
int func_134(int iParam0, int iParam1, int iParam2) // Position - 0xADD3 Hash - 0x61F8C119 ^0x1C9B84EC
{
	int i;
...
int func_135(Ped pedParam0) // Position - 0xAE1F Hash - 0xDCBB968F ^0xDCBB968F
{
	int i;
...
BOOL func_136(Ped pedParam0) // Position - 0xAE68 Hash - 0x7E48B415 ^0x126328AB
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0xAE88 Hash - 0x3D210083 ^0xF7E7C389
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
...
BOOL func_138(int iParam0) // Position - 0xAEA9 Hash - 0xBF3EFB31 ^0xBF3EFB31
{
	switch (iParam0)
	{
		case 5:
...
void func_139() // Position - 0xAEFC Hash - 0x53295875 ^0x53295875
{
...
BOOL func_140(int iParam0) // Position - 0xAF79 Hash - 0xBF3EFB31 ^0xBF3EFB31
{
	switch (iParam0)
	{
		case 5:
...
void func_141(Any* panParam0, BOOL bParam1, BOOL bParam2) // Position - 0xAFCC Hash - 0x50B95D9E ^0x1806B4C4
{
	int i;
...
BOOL func_142(int iParam0) // Position - 0xB0C1 Hash - 0xBF3EFB31 ^0xBF3EFB31
{
	switch (iParam0)
	{
		case 5:
...
void func_143(BOOL bParam0) // Position - 0xB12C Hash - 0xD10400C0 ^0xB6845444
{
	Player playerIndex;
...
void func_144(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB16B Hash - 0x787E640E ^0x67C15509
{
	if (bParam0)
	{
...
BOOL func_145() // Position - 0xB2B8 Hash - 0xAA7793E3 ^0x3F62CDC8
{
	return IS_BIT_SET(Global_1845281[PLAYER::PLAYER_ID() /*883*/].f_36.f_18, 14);
}

BOOL func_146(Player plParam0, int iParam1) // Position - 0xB2D2 Hash - 0x1A32E11A ^0x81C44B3D
{
	BOOL flag;
...
int func_147(int iParam0, BOOL bParam1) // Position - 0xB32B Hash - 0x1DCD393E ^0x1DCD393E
{
	int num;
	int num2;
...
BOOL func_148(Player plParam0) // Position - 0xB36C Hash - 0x6A46C9B4 ^0x6A46C9B4
{
	Player player;
...
BOOL func_149(Player plParam0) // Position - 0xB38E Hash - 0x68897CDD ^0x7A533860
{
...
BOOL func_150() // Position - 0xB3CD Hash - 0xA525B2F4 ^0xA525B2F4
{
	return IS_BIT_SET(Global_2621446, 3);
}

BOOL func_151() // Position - 0xB3DB Hash - 0xD140D54A ^0xE638D98F
{
...
void func_152(int iParam0) // Position - 0xB402 Hash - 0x1B2EEE72 ^0xEDBC1F9D
{
	if (iParam0 == 1)
...
BOOL func_153(const char* sParam0) // Position - 0xB425 Hash - 0x16488C7A ^0x9FE0E8AD
{
...
void func_154() // Position - 0xB462 Hash - 0xC536DD5 ^0xC536DD5
{
	Global_21152 = 0;
	func_155();
	return;
...
void func_155() // Position - 0xB472 Hash - 0xE32CF1EF ^0xB9A7BEB2
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xB4C9 Hash - 0x152DA0B2 ^0x220E93E9
{
...
void func_157() // Position - 0xB4EB Hash - 0xE60F63BE ^0xE60F63BE
{
	func_163(0);
	func_162();
	func_158();
...
void func_158() // Position - 0xB500 Hash - 0xC95798F1 ^0x61ADB9D7
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
...
BOOL func_159(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB558 Hash - 0xEF9D4F61 ^0xC848BDEA
{
...
void func_160(Vehicle veParam0) // Position - 0xB5AF Hash - 0x94E8CB0B ^0x47923A23
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
void func_161(BOOL bParam0, BOOL bParam1) // Position - 0xB5DB Hash - 0xC86614C6 ^0xCD39041A
{
...
void func_162() // Position - 0xB72C Hash - 0x2A0AC5B7 ^0xAF27577A
{
...
void func_163(int iParam0) // Position - 0xB77D Hash - 0x7E11E9C ^0x544BF257
{
	if (func_168())
		return;
...
void func_164(int iParam0) // Position - 0xB7B0 Hash - 0x4066FEF5 ^0x9787FBDA
{
	if (func_168())
		return;
...
void func_165(BOOL bParam0, BOOL bParam1) // Position - 0xB83A Hash - 0xF40FC178 ^0xA6F60F17
{
	if (bParam0)
	{
		if (func_167(0))
...
BOOL func_166() // Position - 0xB8AE Hash - 0x8DF3D75D ^0x8DF3D75D
{
	return IS_BIT_SET(Global_1956920, 5);
}

BOOL func_167(int iParam0) // Position - 0xB8BC Hash - 0xE8921B44 ^0x4F063755
{
	if (iParam0 == 1)
...
BOOL func_168() // Position - 0xB913 Hash - 0xC41437CB ^0xC41437CB
{
	return IS_BIT_SET(Global_1956920, 19);
}

BOOL func_169(int iParam0) // Position - 0xB922 Hash - 0x2BFED607 ^0x2BFED607
{
...
BOOL func_170(int iParam0) // Position - 0xB963 Hash - 0x5C21BF6B ^0xB5545E1F
{
	int num;
...
void func_171(int iParam0) // Position - 0xB9A8 Hash - 0xF49E441F ^0xE21552CB
{
...
int func_172(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xB9DA Hash - 0x8F9349A ^0xC5C097C1
{
	int i;
...
void func_173(int iParam0, int iParam1) // Position - 0xBB11 Hash - 0x6AC97785 ^0x6AC97785
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xBB60 Hash - 0xECB6C71B ^0xECB6C71B
{
	return func_175(iParam0, Global_44042);
}

BOOL func_175(int iParam0, int iParam1) // Position - 0xBB71 Hash - 0x1FD727E0 ^0x1FD727E0
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_176(int iParam0) // Position - 0xBD52 Hash - 0x3BAB94E9 ^0x3BAB94E9
{
	if (Global_44042 == 15)
		return false;
...
int func_177() // Position - 0xBD74 Hash - 0x613FC6AD ^0xDC7835B3
{
	return func_178(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_178(const char* sParam0, int iParam1) // Position - 0xBD85 Hash - 0x76A2E0AF ^0x8A5231BB
{
	int num;
	const char* str;
	Hash hashKey;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBDCE Hash - 0x77F66043 ^0x77F66043
{
	if (Global_101533 == 10 || Global_101533 == 9)
		return true;
...
void func_180(int iParam0, var uParam1) // Position - 0xBDF2 Hash - 0x4DABA5AB ^0x5B086A56
{
	switch (iParam0)
	{
		case 0:
...
Blip func_181(float fParam0, float fParam1, float fParam2, BOOL bParam3) // Position - 0xC266 Hash - 0xF4E99477 ^0x29669E98
{
	Blip blip;
...
var func_182(BOOL bParam0, var uParam1, var uParam2) // Position - 0xC292 Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
BOOL func_183(int iParam0) // Position - 0xC2A9 Hash - 0xE48228D0 ^0xE48228D0
{
	switch (iParam0)
	{
		case 0:
...
int func_184(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xC338 Hash - 0x3167F4C7 ^0xCE6B9B6A
{
	int num;
...
BOOL func_185(var uParam0, int iParam1) // Position - 0xC36B Hash - 0x4C332810 ^0xCFFAAA23
{
	switch (uParam0->f_16)
	{
		case 0:
...
void func_186() // Position - 0xCB4E Hash - 0x1DF115D ^0x1DF115D
{
	func_27(&(Global_104530.f_2890), &Global_104530, 0, 1, 1, 0);
	return;
}

BOOL func_187(var uParam0) // Position - 0xCB69 Hash - 0xBE0C612E ^0xC181C5F3
{
	float num;
...
void func_188(int iParam0, var uParam1) // Position - 0xCBF7 Hash - 0x16CCAA18 ^0x7DFE6A35
{
	if (iParam0 == 1)
	{
		if (!func_140(uParam1))
...
BOOL func_189(BOOL bParam0) // Position - 0xCC5B Hash - 0x328D4447 ^0x90410402
{
...
BOOL func_190(Vehicle veParam0) // Position - 0xCCF2 Hash - 0x7E47BB06 ^0x692E6B64
{
...
BOOL func_191(int iParam0) // Position - 0xCD1C Hash - 0x97844555 ^0xADCD6DAA
{
	eCharacter character;
...
BOOL func_192() // Position - 0xD439 Hash - 0x4228A1C2 ^0x952FE30F
{
	return Global_101572.f_1;
}

BOOL func_193() // Position - 0xD447 Hash - 0xC20DBA70 ^0xAC4006FB
{
	if (Global_98435 != -1)
...
BOOL func_194() // Position - 0xD46A Hash - 0x3CA1BB47 ^0xB78A1ACB
{
...
BOOL func_195() // Position - 0xD484 Hash - 0xE663B8F6 ^0xE663B8F6
{
	if (Global_79650)
		return true;
...
BOOL func_196() // Position - 0xD4AE Hash - 0xD56328D2 ^0xD56328D2
{
	return Global_101585.f_394 > 0;
}

BOOL func_197(int iParam0, int iParam1) // Position - 0xD4BF Hash - 0xA14C4D3F ^0xA6034F77
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_198() // Position - 0xD4F7 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1575083;
}

BOOL func_199() // Position - 0xD503 Hash - 0x7FE517FE ^0x128A3BC8
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
int func_200(var uParam0) // Position - 0xD51F Hash - 0xF6EE4125 ^0x552733A
{
	int i;
...
int func_201(var uParam0, var uParam1) // Position - 0xD5E3 Hash - 0x47C621F2 ^0xD4FFFCAD
{
...
BOOL func_202(var uParam0, float fParam1, var uParam2, var uParam3) // Position - 0xD620 Hash - 0xEF71070A ^0x3D4398AD
{
	BOOL flag;
	int num;
	int num2;
...
void func_203(var uParam0, var uParam1, var uParam2) // Position - 0xD6DC Hash - 0x1FF67BA7 ^0xF122CC03
{
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0xD847 Hash - 0xA17D549C ^0xEFC25F48
{
	char* str;
...
int func_205(var uParam0, float fParam1, float fParam2, float fParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Position - 0xDA3C Hash - 0xA74186BF ^0x512FC932
{
	var unk;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xDAC4 Hash - 0xF7ECDFD9 ^0x6B079C3E
{
...
void func_207(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xDAFF Hash - 0xC6B752B2 ^0xC6B752B2
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xDB55 Hash - 0x6C235EE0 ^0x9E57F206
{
...
float func_209(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xDBF0 Hash - 0xC22B942A ^0xE0DB8793
{
...
int func_210(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, char* sParam9, var uParam10) // Position - 0xDC2A Hash - 0x42D237C6 ^0x6AD55B68
{
	var unk;
...
void func_211(int iParam0) // Position - 0xDD75 Hash - 0x67413911 ^0x67413911
{
	Global_23297 = iParam0;
	return;
}

BOOL func_212(char* sParam0) // Position - 0xDD82 Hash - 0x5CF3EDA6 ^0x878C8302
{
	var string1;
...
struct<6> func_213() // Position - 0xDDA2 Hash - 0xB37EF8EF ^0xB37EF8EF
{
	var unk;
...
void func_214(Ped pedParam0, var uParam1, int iParam2) // Position - 0xDDC6 Hash - 0xD4C7D099 ^0x162C1E9
{
	int taskSequenceId;
	int taskSequenceId2;
...
BOOL func_215(int iParam0) // Position - 0xE11E Hash - 0xD681AEF7 ^0xD681AEF7
{
...
BOOL func_216(var uParam0) // Position - 0xE13E Hash - 0x42F869D4 ^0xFFADB180
{
...
BOOL func_217(var uParam0) // Position - 0xE156 Hash - 0x6329B93C ^0xCBBB8D92
{
...
Hash func_218() // Position - 0xE17B Hash - 0x9F572D68 ^0x627FA1E7
{
	return joaat("U_M_M_Aldinapoli");
}

char* func_219() // Position - 0xE188 Hash - 0x306ACA3A ^0x4327DD5D
{
	return "Al_DiNapoli";
}

void func_220(var uParam0, const char* sParam1, var uParam2, var uParam3, var uParam4) // Position - 0xE194 Hash - 0xA38693DA ^0xBAAA90B1
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_221(int iParam0, BOOL bParam1) // Position - 0xE285 Hash - 0x3ABFF97A ^0x3ABFF97A
{
	if (iParam0 == -1)
		return;
...
int func_222(int iParam0) // Position - 0xE2C1 Hash - 0x3F6843D0 ^0x973F28A6
{
	if (Global_79385 == iParam0)
		if (Global_79386 == -1)
...
void func_223(var uParam0, int iParam1) // Position - 0xE2FA Hash - 0xA189769D ^0xD7591C4B
{
	BOOL flag;
	int i;
...
BOOL func_224() // Position - 0xE398 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_98822;
}

void func_225(var uParam0) // Position - 0xE3A4 Hash - 0x8EEB5116 ^0x2325FF68
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_226(uParam0);
...
void func_226(var uParam0) // Position - 0xE3BB Hash - 0x1C509C5B ^0x1C509C5B
{
	BOOL flag;
	int num;
	int i;
...
void func_227(int iParam0) // Position - 0xE4A3 Hash - 0xD347101A ^0xCC220E7F
{
	if (iParam0 == -1)
		iParam0 = func_177();
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xE4CB Hash - 0x7D86F6E4 ^0x301DFF03
{
	var unk;
...
void func_229(var uParam0) // Position - 0xE73B Hash - 0x2E98ABB1 ^0xFF31A41F
{
	int i;
	int taskSequenceId;
...
void func_230(Object* pobParam0) // Position - 0xEA3F Hash - 0x4EAFEE58 ^0x34D7ECA6
{
...
void func_231(var uParam0) // Position - 0xEA6A Hash - 0x5209F824 ^0xCFA0F1CA
{
	int i;
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xEAEA Hash - 0x53567DCF ^0x584F6887
{
	int i;
	int num;
	Vehicle playersLastVehicle;
...
BOOL func_233(Ped pedParam0, Vehicle veParam1) // Position - 0xECA8 Hash - 0xFB12ABF0 ^0x730FD205
{
...
BOOL func_234(var uParam0, BOOL bParam1, int iParam2) // Position - 0xECD8 Hash - 0xE9BDE167 ^0x20C575FA
{
	int i;
	int num;
...
BOOL func_235(int iParam0) // Position - 0xEF94 Hash - 0x9E3DCA43 ^0x9E3DCA43
{
...
BOOL func_236(Ped pedParam0, int iParam1) // Position - 0xEFC8 Hash - 0x5EA05E45 ^0x7984EB04
{
	float xSize;
...
BOOL func_237(Ped pedParam0, int iParam1) // Position - 0xF03E Hash - 0xF1789D04 ^0x3F9D1900
{
	return func_238(pedParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_238(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xF056 Hash - 0x275BB58B ^0x275BB58B
{
	BOOL flag;
	var pedBoneCoords;
	int num;
...
BOOL func_239(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Ped pedParam6, int iParam7) // Position - 0xF117 Hash - 0xBBBECF07 ^0xBBBECF07
{
	var hit;
	var endCoords;
	var surfaceNormal;
...
Vector3 func_240(Ped pedParam0, int iParam1) // Position - 0xF243 Hash - 0xA6273130 ^0xF7D9CDEA
{
...
int func_241() // Position - 0xF308 Hash - 0x1398F041 ^0xCD84FF69
{
	int i;
...
BOOL func_242(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xF352 Hash - 0x6EF1707D ^0x8C069CF9
{
	var unk;
...
float func_243(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xF3E3 Hash - 0x596BEA29 ^0x5FBCDBE5
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_244(float fParam0, var uParam1, var uParam2) // Position - 0xF404 Hash - 0xFB6A39D2 ^0x80C9C759
{
	float num;
	float num2;
...
void func_245(var uParam0) // Position - 0xF443 Hash - 0xA4B72113 ^0x62A5EAE1
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_246(Ped pedParam0, Ped pedParam1) // Position - 0xF45E Hash - 0xAA445031 ^0xEBA3F8CF
{
	int i;
...
BOOL func_247(Ped pedParam0) // Position - 0xF49D Hash - 0xEC80536A ^0x2D4CF2B0
{
...
BOOL func_248(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xF4C5 Hash - 0x5B46DA49 ^0x44F718
{
	float radius;
	float num;
	int weaponHash;
...
BOOL func_249(Ped pedParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xF5C0 Hash - 0x1310B579 ^0x2AAFC0CC
{
	float entityCoords;
	float num;
...
BOOL func_250(Ped pedParam0, float fParam1) // Position - 0xF6CC Hash - 0xFA3D7088 ^0x33A74060
{
	var outProjectile;
	var outCoords;
...
BOOL func_251(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xF761 Hash - 0x3F40E5FA ^0xC3BEFE6A
{
	var unk;
	var entityForwardVector;
	float num;
...
BOOL func_252(Ped pedParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xF7EF Hash - 0x18BAE105 ^0x60D3B20E
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
BOOL func_253(int iParam0) // Position - 0xF837 Hash - 0x5B443B41 ^0x5B443B41
{
...
void func_254(Ped pedParam0) // Position - 0xF881 Hash - 0xAD821AF8 ^0x2A9D04A3
{
	int taskSequenceId;
...
BOOL func_255(int iParam0) // Position - 0xF91E Hash - 0x6F2BC7EE ^0x6F2BC7EE
{
	if (iParam0 == -1)
		iParam0 = func_177();
...
BOOL func_256(int iParam0) // Position - 0xF9B3 Hash - 0xDE7BA54D ^0xDE7BA54D
{
...
BOOL func_257() // Position - 0xF9F2 Hash - 0x29CB2928 ^0xE369A18D
{
	if (MISC::IS_PC_VERSION())
...
BOOL func_258() // Position - 0xFA0F Hash - 0x98CCC132 ^0x97B0D6ED
{
	if (Global_98435 != -1)
...
BOOL func_259(int iParam0) // Position - 0xFA32 Hash - 0xC2630182 ^0xFBD23031
{
...
BOOL func_260() // Position - 0xFA66 Hash - 0x25806CBF ^0x25806CBF
{
...
BOOL func_261(int iParam0) // Position - 0xFAA4 Hash - 0x1156B580 ^0x34C7FA05
{
...
BOOL func_262(var uParam0, var uParam1) // Position - 0xFACC Hash - 0x25B5F941 ^0x25B5F941
{
	switch (*uParam0)
	{
		case 37:
...
BOOL func_263(var uParam0) // Position - 0xFB88 Hash - 0x609DF6C8 ^0x920F786A
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
				if (!func_267(&uParam0->f_28[0], 64 /*CHAR_NIGEL*/, -44.6f, -1289.86f, 29.16f, 22.9f, "RC NIGEL", 1))
					flag = false;
...
BOOL func_264(var uParam0, var uParam1) // Position - 0xFD6F Hash - 0x997ECE6E ^0x62FBE4F
{
	...
	{
		*uParam0 = PED::CREATE_PED(26 /*PED_TYPE_MISSION*/, joaat("U_M_M_Aldinapoli"), -59.7094f, -1330.1289f, 32.1963f, 0, true, true);
...
void func_265(Vehicle* pveParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xFE44 Hash - 0x60B41505 ^0x2C4B5209
{
	func_266(pveParam0);
...
void func_266(Vehicle* pveParam0) // Position - 0xFE87 Hash - 0x8D18F713 ^0xF71A18A8
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
BOOL func_267(Ped* ppedParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xFF23 Hash - 0x5E27D69A ^0xE8A3C3CE
{
...
BOOL func_268(Ped* ppedParam0, eCharacter echParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xFF7F Hash - 0xC57592AD ^0x9AA0BE7
{
	Hash model;
...
int func_269(Ped pedParam0, eCharacter echParam1) // Position - 0x1000E Hash - 0x5AC42C11 ^0x5AC42C11
{
	int num;
...
BOOL func_270(var uParam0) // Position - 0x10054 Hash - 0xB319BDFA ^0xA1F4DAFB
{
	if (func_217(uParam0))
	{
...
BOOL func_271(var uParam0) // Position - 0x1007E Hash - 0xC42B20E0 ^0x728F1DAE
{
	int i;
...
void func_272(var uParam0, char* sParam1, char* sParam2, char* sParam3) // Position - 0x100AF Hash - 0x6EEDFC2 ^0xD51569DC
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = sParam3;
...
BOOL func_273(var uParam0) // Position - 0x100EB Hash - 0xAD6E5A83 ^0x65BDAA63
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
				if (!func_267(&uParam0->f_28[0], 64 /*CHAR_NIGEL*/, -1310.65f, -640.17f, 26.52f, 153.43f, "RC NIGEL", 1))
					flag = false;
...
void func_274(int iParam0, BOOL bParam1) // Position - 0x10306 Hash - 0xAC7E930 ^0xD19C991B
{
	switch (iParam0)
	{
		case 37:
...
void func_275(BOOL bParam0) // Position - 0x10720 Hash - 0xF6AEE488 ^0xF6AEE488
{
	Vector3 vector;
	Vector3 vector2;
	Vector3 vector3;
...
void func_276() // Position - 0x107B1 Hash - 0xDFA77216 ^0x14B383AD
{
	PED::SET_PED_NON_CREATION_AREA(-1112.99f, 774.12f, 151.77f, -1077.99f, 853.65f, 187.66f);
	return;
}

int func_277() // Position - 0x107DB Hash - 0x5A4670E ^0xE582B183
{
	return PED::ADD_SCENARIO_BLOCKING_AREA(-1212.16f, 634.82f, 138.5f, -1010.08f, 830.94f, 180.47f, false, true, true, true, 1);
}

BOOL func_278(var uParam0, var uParam1) // Position - 0x1080A Hash - 0x6C7C9C93 ^0x50829581
{
	int num;
	char* animDict;
	int i;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			func_274(41, true);
			uParam0->f_28[0] = PED::CREATE_PED(26 /*PED_TYPE_MISSION*/, num[3], -1096.855f, 67.6858f, 52.952f, 112f, true, true);
			...
			TASK::CLEAR_SEQUENCE_TASK(&taskSequenceId);
			uParam0->f_28[1] = PED::CREATE_PED(26 /*PED_TYPE_MISSION*/, num[4], -1096.2576f, 69.723f, 53.0107f, 163f, true, true);
			...
			uParam0->f_28[2] = PED::CREATE_PED(26 /*PED_TYPE_MISSION*/, num[0], -1105.6224f, 66.4609f, 53.07f, 118f, true, true);
			uParam0->f_28[3] = PED::CREATE_PED(26 /*PED_TYPE_MISSION*/, num[0], -1090.0902f, 64.3905f, 52.5607f, 238f, true, true);
			uParam0->f_28[4] = PED::CREATE_PED(26 /*PED_TYPE_MISSION*/, num[0], -1093.736f, 73.8568f, 53.0388f, 319f, true, true);
...
void func_279(var uParam0) // Position - 0x10DFE Hash - 0x6A0A7C37 ^0x4AB04E31
{
	int i;
	float num;
...
void func_280(var uParam0, float fParam1, float fParam2, float fParam3) // Position - 0x10E9E Hash - 0x488A8B25 ^0x21309DD6
{
	uParam0->f_51 == 0;
	uParam0->f_46 >= 15;
...
void func_281(var uParam0) // Position - 0x10ECF Hash - 0x94803123 ^0x38D79261
{
	uParam0->f_51;
	uParam0->f_46 = 0;
...
BOOL func_282(var uParam0) // Position - 0x10EF6 Hash - 0x2982410F ^0xAF3EF95E
{
	int num;
	int i;
	char* animDict;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			uParam0->f_28[0] = PED::CREATE_PED(26 /*PED_TYPE_MISSION*/, num[0], -626.87f, -268.85f, 38f, 121f, true, true);
			PED::SET_PED_COMPONENT_VARIATION(uParam0->f_28[0], 0 /*PV_COMP_HEAD*/, 1, 1, 0);
			PED::SET_PED_COMPONENT_VARIATION(uParam0->f_28[0], 2 /*PV_COMP_HAIR*/, 1, 2, 0);
			PED::SET_PED_COMPONENT_VARIATION(uParam0->f_28[0], 3 /*PV_COMP_UPPR*/, 0, 0, 0);
			PED::SET_PED_COMPONENT_VARIATION(uParam0->f_28[0], 4 /*PV_COMP_LOWR*/, 0, 0, 0);
			PED::SET_PED_COMBAT_ATTRIBUTES(uParam0->f_28[0], 17 /*BF_AlwaysFlee*/, true);
			...
			TASK::TASK_PERFORM_SEQUENCE(uParam0->f_28[0], taskSequenceId);
			TASK::CLEAR_SEQUENCE_TASK(&taskSequenceId);
			uParam0->f_28[1] = PED::CREATE_PED(26 /*PED_TYPE_MISSION*/, num[1], -627.4f, -267.12f, 38.23f, -59.95f, true, true);
			PED::SET_PED_COMPONENT_VARIATION(uParam0->f_28[1], 3 /*PV_COMP_UPPR*/, 0, 3, 0);
...
BOOL func_283(var uParam0) // Position - 0x11224 Hash - 0xC53F5133 ^0x7E39DD25
{
	int num;
	int i;
	char* animDict;
	...
	switch (iLocal_89)
	{
		...
		case 3:
			...
			func_285(&uParam0->f_28[0], num[0], -1054.7f, 355.94f, 68.35f, 23.67f, 26 /*PED_TYPE_MISSION*/);
			...
			func_285(&uParam0->f_28[1], num[1], -1058.43f, 362.78f, 69.86f, 130.45f, 26 /*PED_TYPE_MISSION*/);
		
			if (func_136(uParam0->f_28[1]))
			{
				PED::SET_PED_COMPONENT_VARIATION(uParam0->f_28[1], 0 /*PV_COMP_HEAD*/, 0, 0, 0);
				PED::SET_PED_COMPONENT_VARIATION(uParam0->f_28[1], 2 /*PV_COMP_HAIR*/, 0, 0, 0);
				PED::SET_PED_COMPONENT_VARIATION(uParam0->f_28[1], 3 /*PV_COMP_UPPR*/, 0, 2, 0);
				PED::SET_PED_COMPONENT_VARIATION(uParam0->f_28[1], 4 /*PV_COMP_LOWR*/, 0, 0, 0);
				PED::SET_PED_COMPONENT_VARIATION(uParam0->f_28[1], 8 /*PV_COMP_ACCS*/, 0, 1, 0);
			...
			func_285(&uParam0->f_28[2], num[2], -1012.57f, 357.48f, 70.62f, -28.55f, 26 /*PED_TYPE_MISSION*/);
...
void func_284(Object* pobParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0x11787 Hash - 0x61F651EE ^0x2FE58679
{
	func_230(pobParam0);
...
void func_285(Ped* ppedParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5, ePedType eptParam6) // Position - 0x117AE Hash - 0x616C5024 ^0x190F8C82
{
	func_286(ppedParam0);
...
void func_286(Ped* ppedParam0) // Position - 0x117CF Hash - 0xCA79453F ^0x7BA88177
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*ppedParam0, false))
...
BOOL func_287(var uParam0) // Position - 0x11810 Hash - 0x421FB2BB ^0x740FF9FB
{
	int num;
	int i;
	Interior interiorAtCoordsWithType;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			func_285(&uParam0->f_28[0], num[0], -552.66f, 287.75f, 82.18f, 123.75f, 26 /*PED_TYPE_MISSION*/);
			func_285(&uParam0->f_28[1], num[1], -553.46f, 287.34f, 82.18f, -65.86f, 26 /*PED_TYPE_MISSION*/);
		
			if (func_136(uParam0->f_28[1]))
			{
				PED::SET_PED_CAN_BE_TARGETTED(uParam0->f_28[1], false);
				PED::SET_PED_COMPONENT_VARIATION(uParam0->f_28[1], 0 /*PV_COMP_HEAD*/, 1, 0, 0);
				PED::SET_PED_COMPONENT_VARIATION(uParam0->f_28[1], 2 /*PV_COMP_HAIR*/, 0, 2, 0);
				PED::SET_PED_COMPONENT_VARIATION(uParam0->f_28[1], 3 /*PV_COMP_UPPR*/, 1, 2, 0);
				PED::SET_PED_COMPONENT_VARIATION(uParam0->f_28[1], 4 /*PV_COMP_LOWR*/, 0, 1, 0);
				PED::SET_PED_COMPONENT_VARIATION(uParam0->f_28[1], 7 /*PV_COMP_TEEF*/, 0, 1, 0);
				PED::SET_PED_COMPONENT_VARIATION(uParam0->f_28[1], 8 /*PV_COMP_ACCS*/, 1, 0, 0);
			}
			...
			func_285(&uParam0->f_28[2], num[2], -559.94f, 285.99f, 85.38f, -59.06f, 26 /*PED_TYPE_MISSION*/);
			func_285(&uParam0->f_28[3], num[3], -558.87f, 289.79f, 85.38f, 162.44f, 26 /*PED_TYPE_MISSION*/);
			func_285(&uParam0->f_28[4], num[4], -559f, 286.09f, 85.38f, 65.92f, 26 /*PED_TYPE_MISSION*/);
			func_285(&uParam0->f_28[5], num[5], -558.84f, 288.97f, 85.38f, -7.72f, 26 /*PED_TYPE_MISSION*/);
		
			if (func_136(uParam0->f_28[2]))
			{
				PED::SET_PED_COMPONENT_VARIATION(uParam0->f_28[2], 0 /*PV_COMP_HEAD*/, 0, 1, 0);
				PED::SET_PED_COMPONENT_VARIATION(uParam0->f_28[2], 2 /*PV_COMP_HAIR*/, 1, 2, 0);
				PED::SET_PED_COMPONENT_VARIATION(uParam0->f_28[2], 3 /*PV_COMP_UPPR*/, 1, 1, 0);
				PED::SET_PED_COMPONENT_VARIATION(uParam0->f_28[2], 4 /*PV_COMP_LOWR*/, 1, 0, 0);
				PED::SET_PED_COMPONENT_VARIATION(uParam0->f_28[2], 7 /*PV_COMP_TEEF*/, 1, 0, 0);
				PED::SET_PED_COMPONENT_VARIATION(uParam0->f_28[2], 8 /*PV_COMP_ACCS*/, 1, 0, 0);
			}
		
			if (func_136(uParam0->f_28[3]))
			{
				PED::SET_PED_COMPONENT_VARIATION(uParam0->f_28[3], 0 /*PV_COMP_HEAD*/, 1, 1, 0);
				PED::SET_PED_COMPONENT_VARIATION(uParam0->f_28[3], 2 /*PV_COMP_HAIR*/, 1, 0, 0);
				PED::SET_PED_COMPONENT_VARIATION(uParam0->f_28[3], 3 /*PV_COMP_UPPR*/, 1, 0, 0);
				PED::SET_PED_COMPONENT_VARIATION(uParam0->f_28[3], 4 /*PV_COMP_LOWR*/, 1, 1, 0);
				PED::SET_PED_COMPONENT_VARIATION(uParam0->f_28[3], 7 /*PV_COMP_TEEF*/, 1, 0, 0);
				PED::SET_PED_COMPONENT_VARIATION(uParam0->f_28[3], 8 /*PV_COMP_ACCS*/, 1, 0, 0);
			}
		
			if (func_136(uParam0->f_28[4]))
			{
				PED::SET_PED_COMPONENT_VARIATION(uParam0->f_28[4], 0 /*PV_COMP_HEAD*/, 0, 0, 0);
				PED::SET_PED_COMPONENT_VARIATION(uParam0->f_28[4], 2 /*PV_COMP_HAIR*/, 0, 2, 0);
				PED::SET_PED_COMPONENT_VARIATION(uParam0->f_28[4], 3 /*PV_COMP_UPPR*/, 0, 0, 0);
				PED::SET_PED_COMPONENT_VARIATION(uParam0->f_28[4], 4 /*PV_COMP_LOWR*/, 0, 1, 0);
				PED::SET_PED_COMPONENT_VARIATION(uParam0->f_28[4], 8 /*PV_COMP_ACCS*/, 0, 0, 0);
			}
		
			if (func_136(uParam0->f_28[5]))
			{
				PED::SET_PED_COMPONENT_VARIATION(uParam0->f_28[5], 0 /*PV_COMP_HEAD*/, 1, 0, 0);
				PED::SET_PED_COMPONENT_VARIATION(uParam0->f_28[5], 2 /*PV_COMP_HAIR*/, 2, 0, 0);
				PED::SET_PED_COMPONENT_VARIATION(uParam0->f_28[5], 3 /*PV_COMP_UPPR*/, 0, 3, 0);
				PED::SET_PED_COMPONENT_VARIATION(uParam0->f_28[5], 4 /*PV_COMP_LOWR*/, 1, 0, 0);
				PED::SET_PED_COMPONENT_VARIATION(uParam0->f_28[5], 8 /*PV_COMP_ACCS*/, 0, 2, 0);
			}
...
void func_288(int iParam0, BOOL bParam1) // Position - 0x11D5E Hash - 0x514025D8 ^0x8CB44699
{
	char* string2;
	Interior interior;
...
BOOL func_289(int iParam0) // Position - 0x11E25 Hash - 0x3EFCD0D0 ^0xC443C103
{
	int num;
...
struct<2> func_290(int iParam0) // Position - 0x11E56 Hash - 0x87F664E1 ^0xB5A53089
{
	int num;
...
void func_291(int iParam0, BOOL bParam1) // Position - 0x11E83 Hash - 0x159D970A ^0x2BF0B4B
{
	int offset;
...
char* func_292(int iParam0, var uParam1) // Position - 0x11EC6 Hash - 0x724FFEBB ^0x3397F292
{
	Vector3 vector;
...
struct<5> func_293(int iParam0) // Position - 0x11EEB Hash - 0xAA1C3943 ^0x228702FD
{
	var unk;
	var unk6;
...
char* func_294(char* sParam0) // Position - 0x14B4D Hash - 0xC9D82232 ^0xC9D82232
{
	return sParam0;
}

struct<6> func_295(int iParam0, BOOL bParam1) // Position - 0x14B57 Hash - 0x293B24C9 ^0x49F602D8
{
	var unk;
...
BOOL func_296(var uParam0) // Position - 0x1570D Hash - 0x609DF6C8 ^0x920F786A
{
	int num;
	int i;
	int num2;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			if (!func_267(&uParam0->f_28[0], 64 /*CHAR_NIGEL*/, -1100.5f, 789.8f, 164.34f, 1.82f, "RC: NIGEL", 1))
				flag = false;
		
			if (!func_267(&uParam0->f_28[1], 63 /*CHAR_MRS_THORNHILL*/, -1099.35f, 789.15f, 164.47f, 0f, "RC: MRS THORNHILL", 1))
				flag = false;
...
BOOL func_297(int iParam0) // Position - 0x159AE Hash - 0x59D2F680 ^0x59D2F680
{
	var unk;
	eCharacter character;
...
BOOL func_298(int iParam0) // Position - 0x159FF Hash - 0xC6B32843 ^0x336CA048
{
	const char* string2;
...
BOOL func_299(int iParam0) // Position - 0x15AB8 Hash - 0x791D84F4 ^0x791D84F4
{
	var unk;
...
BOOL func_300(int iParam0) // Position - 0x15B79 Hash - 0xDEAD9A68 ^0xDEAD9A68
{
	int i;
	var interiorType;
	Interior interiorAtCoordsWithType;
...
BOOL func_301(int iParam0, char* sParam1) // Position - 0x15BFE Hash - 0xC64245F ^0x483F8E5B
{
...
BOOL func_302(int iParam0) // Position - 0x15CE0 Hash - 0x5ADD7F05 ^0x5ADD7F05
{
...
BOOL func_303(int iParam0) // Position - 0x15D0B Hash - 0xBB053D24 ^0xBB053D24
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_304(int iParam0) // Position - 0x15D36 Hash - 0x5D95A044 ^0x5D95A044
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_305(int iParam0) // Position - 0x15D61 Hash - 0x9FFC81CD ^0x47A2AB8B
{
	if (func_256(iParam0))
		return false;
	else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
...
void func_306() // Position - 0x15D96 Hash - 0x5631C87C ^0x7CAB970D
{
...
BOOL func_307(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x15DB0 Hash - 0x5B983661 ^0x5B983661
{
	int i;
...
BOOL func_308(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0x15E15 Hash - 0xC6B7068B ^0xB9A971A4
{
	int num;
	char* str;
...
BOOL func_309(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x15E8D Hash - 0x1FB736D4 ^0x234AEAB7
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_310(var uParam0, var uParam1, BOOL bParam2) // Position - 0x15F08 Hash - 0xEEE30310 ^0x785E9DE5
{
	char* str;
...
void func_311(char* sParam0) // Position - 0x15FF2 Hash - 0xA52CF679 ^0xC94F8C8B
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
		if (func_212(sParam0))
			func_312();
...
void func_312() // Position - 0x16011 Hash - 0xC536DD5 ^0xC536DD5
{
	Global_21152 = 0;
	func_313();
	return;
...
void func_313() // Position - 0x16021 Hash - 0xF6D04E68 ^0x80AE5309
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_23297 = 0;
...
int func_314(var uParam0) // Position - 0x16042 Hash - 0x86633390 ^0x6176105E
{
	if (func_217(uParam0))
	{
		if (STREAMING::HAS_ANIM_DICT_LOADED(*uParam0))
...
void func_315(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x16078 Hash - 0x5BE1D1E3 ^0x5BE1D1E3
{
...
void func_316(var uParam0, BOOL bParam1) // Position - 0x16098 Hash - 0xEDC3BD2D ^0xE0B6F056
{
	func_317(&(uParam0->f_41), bParam1);
	return;
}

void func_317(var uParam0, BOOL bParam1) // Position - 0x160AA Hash - 0x9E80EA71 ^0x9E80EA71
{
	int i;
...
void func_318(Object* pobParam0, BOOL bParam1) // Position - 0x160E8 Hash - 0xD7EE3E27 ^0xC5769B29
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_319(var uParam0, BOOL bParam1) // Position - 0x16123 Hash - 0xEDC3BD2D ^0xE2474F74
{
	func_320(&(uParam0->f_35), bParam1);
	return;
}

void func_320(var uParam0, BOOL bParam1) // Position - 0x16135 Hash - 0xA98F6284 ^0xA98F6284
{
	int i;
...
void func_321(Vehicle* pveParam0) // Position - 0x16172 Hash - 0xC50F9886 ^0x638B6124
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_322(var uParam0, int iParam1) // Position - 0x161AA Hash - 0xEDC3BD2D ^0xA9A19095
{
	func_323(&(uParam0->f_28), iParam1);
	return;
}

void func_323(var uParam0, int iParam1) // Position - 0x161BC Hash - 0xB72ACFD2 ^0xB72ACFD2
{
	int i;
...
void func_324(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x161FD Hash - 0x34362197 ^0xC592197
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
void func_325(var uParam0) // Position - 0x1624D Hash - 0x3BB5652F ^0xD5D2D18B
{
	if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(uParam0->f_59))
	{
		if (func_136(uParam0->f_28[1]))
		{
			if (func_326(uParam0->f_28[1], joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE") /*SCRIPT_TASK_SYNCHRONIZED_SCENE*/))
...
BOOL func_326(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x1629E Hash - 0x5CB13EA9 ^0x50B73240
{
...
void func_327(var uParam0) // Position - 0x162D1 Hash - 0x73752192 ^0x129315BF
{
	if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(uParam0->f_59))
	{
		if (func_136(uParam0->f_28[0]))
		{
			if (func_326(uParam0->f_28[0], joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE") /*SCRIPT_TASK_SYNCHRONIZED_SCENE*/))
...
void func_328(int iParam0) // Position - 0x16360 Hash - 0x995C9E2 ^0x995C9E2
{
	if (*iParam0 == -1)
		return;
...
void func_329(char* sParam0) // Position - 0x1639D Hash - 0x54B64147 ^0x56EEAFB9
{
	!MISC::IS_STRING_NULL_OR_EMPTY(sParam0);
	return;
}

void func_330(var uParam0) // Position - 0x163AF Hash - 0x4CD8BCE8 ^0xBF13C7FD
{
	*uParam0 = -1;
...
void func_331() // Position - 0x163E2 Hash - 0x554DA35 ^0xFBCCE57F
{
...
Hash func_332(eCharacter echParam0) // Position - 0x163FC Hash - 0xBF0B24A5 ^0xBF0B24A5
{
	if (!func_36(echParam0))
