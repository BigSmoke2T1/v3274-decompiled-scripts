...
void main() // Position - 0x0 Hash - 0x5D84F89F ^0x5D84F89F
{
	...
	while (iLocal_278 && func_48(5, 0))
	{
		...
		if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
			if (iLocal_112 == 258 && func_45(13) == 2 /*CHAR_TREVOR*/)
				func_68();
				...
				if (!bLocal_501)
				{
					...
					else
					{
						...
						if (!MISC::IS_STRING_NULL_OR_EMPTY(&uLocal_492))
							_CONVERSATION_INITIALIZE_ACTOR(&uLocal_113, 4 /*CHAR_ALL_PLAYERS_CONF*/, iLocal_279[0], &uLocal_492, 0, 1);
...
void func_22() // Position - 0xA22 Hash - 0xD1F2D853 ^0xF9F5FD4D
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_113969.f_2366.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_26(character) && !func_15(14) || Global_112917)
			{
		...
		if (!PED::IS_PED_INJURED(uParam0->[i]))
		{
			switch (uParam1->[i])
			{
				case 100:
					...
					{
						TASK::TASK_SYNCHRONIZED_SCENE(uParam0->[i], Global_98842, &uLocal_370, &uLocal_386[i /*16*/], 8f, -1000f, 0, 0, 1148846080, 0);
						uParam1->[i] = 101;
					}
				...
				case 101:
					if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_98843))
					{
						TASK::TASK_SYNCHRONIZED_SCENE(uParam0->[i], Global_98843, &uLocal_370, &uLocal_419[i /*16*/], 8f, -1000f, 0, 0, 1148846080, 0);
				...
				case 102:
					if (STREAMING::HAS_ANIM_DICT_LOADED(&uLocal_370) && ENTITY::IS_ENTITY_PLAYING_ANIM(uParam0->[i], &uLocal_370, &uLocal_419[i /*16*/], 2))
					{
						...
						{
							if (num < PED::GET_SYNCHRONIZED_SCENE_PHASE(Global_98843))
							{
				...
				case 0:
					...
					if (num6 > 45f)
					{
						if (!(TASK::GET_SCRIPT_TASK_STATUS(uParam0->[i], joaat("SCRIPT_TASK_ACHIEVE_HEADING") /*SCRIPT_TASK_ACHIEVE_HEADING*/) == 1))
				...
				case 1:
					...
					if (!(TASK::GET_SCRIPT_TASK_STATUS(uParam0->[i], joaat("SCRIPT_TASK_FOLLOW_NAV_MESH_TO_COORD") /*SCRIPT_TASK_FOLLOW_NAV_MESH_TO_COORD*/) == 1) && !(TASK::GET_SCRIPT_TASK_STATUS(uParam0->[i], joaat("SCRIPT_TASK_FOLLOW_NAV_MESH_TO_COORD") /*SCRIPT_TASK_FOLLOW_NAV_MESH_TO_COORD*/) == 0))
					{
				...
				case 10:
					if (TASK::GET_SCRIPT_TASK_STATUS(uParam0->[i], joaat("SCRIPT_TASK_PUT_PED_DIRECTLY_INTO_MELEE") /*SCRIPT_TASK_PUT_PED_DIRECTLY_INTO_MELEE*/) == 7 || TASK::GET_SCRIPT_TASK_STATUS(uParam0->[i], joaat("SCRIPT_TASK_PUT_PED_DIRECTLY_INTO_MELEE") /*SCRIPT_TASK_PUT_PED_DIRECTLY_INTO_MELEE*/) == 1)
					{
...
BOOL func_29(Entity eParam0, float fParam1) // Position - 0x1637 Hash - 0x2B651718 ^0x10130CD
{
	...
	for (i = 0; i < 263; i = i + 1)
	{
		if (IS_BIT_SET(Global_33328[i /*23*/].f_11, 0))
		{
			if (Global_33328[i /*23*/].f_16 == 9)
			{
			}
			else
			{
				...
				if (IS_BIT_SET(Global_33328[i /*23*/].f_11, 19))
				{
					num = 3;
...
int func_48(int iParam0, Ped pedParam1) // Position - 0x1EB8 Hash - 0xD1960A5B ^0x3A103378
{
	...
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		else if (pedParam1 == func_49(Global_101254) && pedParam1 != 0)
		{
			Global_101254 = 0;
		}
	}
...
void func_56() // Position - 0x2068 Hash - 0x5FE162C2 ^0x7DC450CE
{
	...
	for (i = 0; i < iLocal_279; i = i + 1)
	{
		if (iLocal_285[i] != 0)
		{
			iLocal_279[i] = PED::CREATE_PED(26 /*PED_TYPE_MISSION*/, iLocal_285[i], uLocal_298 + uLocal_302[i /*3*/], 0, true, true);
			...
			if (iLocal_285[i] == joaat("S_M_Y_BayWatch_01"))
				if (PED::GET_PED_DRAWABLE_VARIATION(iLocal_279[i], 3 /*PV_COMP_UPPR*/) == 0)
					if (PED::GET_PED_DRAWABLE_VARIATION(iLocal_279[i], 10 /*PV_COMP_DECL*/) != 1)
						PED::SET_PED_COMPONENT_VARIATION(iLocal_279[i], 10 /*PV_COMP_DECL*/, 1, 0, 0);
				else if (PED::GET_PED_DRAWABLE_VARIATION(iLocal_279[i], 10 /*PV_COMP_DECL*/) == 1)
					if (PED::GET_PED_DRAWABLE_VARIATION(iLocal_279[i], 10 /*PV_COMP_DECL*/) != 0)
						PED::SET_PED_COMPONENT_VARIATION(iLocal_279[i], 10 /*PV_COMP_DECL*/, 0, 0, 0);
	...
	switch (iParam0)
	{
		...
		case 5:
			*uParam1 = Global_113969.f_2366.f_539.f_2310[0];
			TEXT_LABEL_ASSIGN_STRING(sParam2, func_67(Global_113969.f_2366.f_539.f_2314[0]), 32);
			return true;
	
		case 6:
			*uParam1 = Global_113969.f_2366.f_539.f_2310[1];
			TEXT_LABEL_ASSIGN_STRING(sParam2, func_67(Global_113969.f_2366.f_539.f_2314[1]), 32);
			return true;
	
		case 7:
			*uParam1 = Global_113969.f_2366.f_539.f_2310[2];
			TEXT_LABEL_ASSIGN_STRING(sParam2, func_67(Global_113969.f_2366.f_539.f_2314[2]), 32);
			return true;
