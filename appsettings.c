			...
			switch (Global_20930.f_1)
			{
				...
				case 8:
					...
					else
					{
						...
						if (func_10(2 /*FRONTEND_CONTROL*/, Global_20898, 0))
						{
							if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
								AUDIO::STOP_PED_RINGTONE(PLAYER::PLAYER_PED_ID());
...
void func_12() // Position - 0x890 Hash - 0x76A20FA9 ^0x47806803
{
	...
	if (iLocal_41 == 1)
	{
		...
		if (func_10(2 /*FRONTEND_CONTROL*/, Global_20906, 0) || func_10(2 /*FRONTEND_CONTROL*/, Global_20907, 0) || bLocal_49 || iLocal_63 == 1 || iLocal_64 == 1)
		{
			iLocal_63 = 0;
			iLocal_64 = 0;
			bLocal_49 = false;
	...
	{
		if (func_10(2 /*FRONTEND_CONTROL*/, Global_20899, 0))
		{
			func_24();
			Global_20908 = true;
			GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(Global_20911, "GET_CURRENT_SELECTION");
...
void func_20(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x1523 Hash - 0x99A9B13C ^0x970C9246
{
	Hash statName;
...
void func_29() // Position - 0x1A3D Hash - 0xFDECAEB0 ^0xE7593BB9
{
	...
	if (PAD::IS_USING_KEYBOARD_AND_MOUSE(2 /*FRONTEND_CONTROL*/))
	{
		if (func_10(2 /*FRONTEND_CONTROL*/, 181 /*INPUT_CELLPHONE_SCROLL_BACKWARD*/, 0))
		{
			if (iLocal_38 > 0)
		...
		if (func_10(2 /*FRONTEND_CONTROL*/, 180 /*INPUT_CELLPHONE_SCROLL_FORWARD*/, 0))
		{
			iLocal_38 = iLocal_38 + 1;
	...
	if (bLocal_60 == false)
	{
		if (func_10(2 /*FRONTEND_CONTROL*/, Global_20906, 0))
		{
			if (iLocal_38 > 0)
				iLocal_38 = iLocal_38 - 1;
		...
		if (func_10(2 /*FRONTEND_CONTROL*/, Global_20907, 0))
		{
			iLocal_38 = iLocal_38 + 1;
...
int func_45(int iParam0, int iParam1) // Position - 0x20F6 Hash - 0x744E461C ^0x36023077
{
	Hash statHash;
	int outValue;
