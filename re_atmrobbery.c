	...
	while (true)
	{
			...
			if (BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
			{
				switch (iLocal_92)
				{
					...
					case 1:
						...
						if (shLocal_111 == 0)
							shLocal_111 = EVENT::ADD_SHOCKING_EVENT_AT_POSITION(101 /*EVENT_SHOCKING_MUGGING*/, uLocal_93, 30000f);
		...
		else
		{
			if (ENTITY::DOES_ENTITY_EXIST(pedLocal_97))
			{
				if (!PED::IS_PED_INJURED(pedLocal_97))
				{
					if (func_183(pedLocal_97, joaat("SCRIPT_TASK_SMART_FLEE_POINT") /*SCRIPT_TASK_0xF10822AA*/))
					{
					...
					else if (func_183(pedLocal_97, joaat("SCRIPT_TASK_STAND_STILL") /*SCRIPT_TASK_STAND_STILL*/))
					{
						TASK::CLEAR_PED_TASKS(pedLocal_97);
						TASK::TASK_SMART_FLEE_PED(pedLocal_97, PLAYER::PLAYER_PED_ID(), 300f, -1, false, false);
					}
			...
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				if (!func_133() && !func_130())
				{
					...
					if (HUD::DOES_BLIP_EXIST(blLocal_101))
					{
							...
							if (bLocal_336)
							{
								if (ENTITY::IS_ENTITY_AT_ENTITY(pedLocal_97, PLAYER::PLAYER_PED_ID(), fLocal_342, fLocal_342, fLocal_342, false, true, 0))
								{
									if (!PED::IS_PED_IN_ANY_VEHICLE(pedLocal_97, false))
									{
										if (SYSTEM::TIMERA() > 1000)
										{
											...
											PED::SET_PED_COMBAT_ATTRIBUTES(pedLocal_97, 17 /*BF_AlwaysFlee*/, false);
										}
									}
								}
								else if (!bLocal_338)
								{
									if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), pedLocal_97, 25f, 25f, 25f, false, true, 0))
									{
										if (!PED::IS_PED_IN_ANY_VEHICLE(pedLocal_97, false))
										{
											PED::SET_PED_COMBAT_ATTRIBUTES(pedLocal_97, 17 /*BF_AlwaysFlee*/, true);
											PED::SET_PED_COMBAT_ATTRIBUTES(pedLocal_97, 13 /*BF_Aggressive*/, false);
											func_122();
											bLocal_338 = true;
										}
									}
						...
						{
							if (PED::IS_PED_INJURED(pedLocal_97) || PED::IS_PED_DEAD_OR_DYING(pedLocal_97, true) || func_183(pedLocal_97, joaat("SCRIPT_TASK_WRITHE") /*SCRIPT_TASK_WRITHE*/))
							{
		...
		if (!bLocal_149)
		{
			if (bLocal_339)
			{
				...
				else
				{
					...
					if (!func_101())
					{
						if (!func_183(pedLocal_98, joaat("SCRIPT_TASK_GO_TO_ENTITY") /*SCRIPT_TASK_GO_TO_ENTITY*/) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true))
						{
							TASK::CLEAR_PED_TASKS(pedLocal_98);
							TASK::TASK_GO_TO_ENTITY(pedLocal_98, PLAYER::PLAYER_PED_ID(), 20000, 1056964608, 1f, 1073741824, 0);
						}
					}
					else if (func_183(pedLocal_98, joaat("SCRIPT_TASK_GO_TO_ENTITY") /*SCRIPT_TASK_GO_TO_ENTITY*/))
					{
						TASK::CLEAR_PED_TASKS(pedLocal_98);
						TASK::CLEAR_SEQUENCE_TASK(&iLocal_103);
						TASK::OPEN_SEQUENCE_TASK(&iLocal_103);
...
void func_10(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x3585 Hash - 0x99A9B13C ^0x970C9246
{
	Hash statName;
...
int func_17(int iParam0, int iParam1) // Position - 0x37E6 Hash - 0x744E461C ^0x36023077
{
	Hash statHash;
	int outValue;
...
int func_52(var uParam0, char* sParam1, char* sParam2, var uParam3, char* sParam4, var uParam5, int iParam6, int iParam7, int iParam8) // Position - 0x40BE Hash - 0xBDF71325 ^0xBDF71325
{
	...
	func_63(uParam0, 145 /*_CHAR_NULL*/, sParam1, iParam7, iParam8, 0);
...
BOOL func_87(Player plParam0, int iParam1) // Position - 0x588A Hash - 0x1A32E11A ^0x81C44B3D
{
	BOOL flag;
	...
	if (plParam0 == PLAYER::PLAYER_ID())
		flag = func_88(-1, false) == 8 /*CHAR_MIKE_FRANK_CONF*/;
	else
...
BOOL func_90(Player plParam0) // Position - 0x5946 Hash - 0x68897CDD ^0x7A533860
{
...
void func_110() // Position - 0x6388 Hash - 0x74AED58B ^0x9A4461F0
{
	...
	else
	{
		if (!bLocal_141)
		{
			if (!func_183(pedLocal_98, joaat("SCRIPT_TASK_PERFORM_SEQUENCE") /*SCRIPT_TASK_PERFORM_SEQUENCE*/) && !PED::IS_PED_INJURED(pedLocal_98))
			{
				TASK::OPEN_SEQUENCE_TASK(&iLocal_103);
		...
		if (bLocal_141)
		{
			if (!bLocal_145)
			{
				if (!PED::IS_PED_INJURED(pedLocal_98))
				{
					...
					else if (TASK::GET_SCRIPT_TASK_STATUS(pedLocal_98, joaat("SCRIPT_TASK_PERFORM_SEQUENCE") /*SCRIPT_TASK_PERFORM_SEQUENCE*/) == 7)
					{
						TASK::CLEAR_PED_TASKS(pedLocal_98);
						TASK::OPEN_SEQUENCE_TASK(&iLocal_103);
						TASK::TASK_PLAY_ANIM(0, sLocal_143, "pickup_low", 1090519040, -1056964608, -1, 0, 0, false, false, false);
						TASK::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), 3000, 2048 /*SLF_WHILE_NOT_IN_FOV*/, 2);
						TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 3000);
						TASK::TASK_WANDER_STANDARD(0, 1193033728, 0);
						TASK::CLOSE_SEQUENCE_TASK(iLocal_103);
						TASK::TASK_PERFORM_SEQUENCE(pedLocal_98, iLocal_103);
		...
		case 2:
			...
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(veLocal_115, false) && PED::IS_PED_IN_VEHICLE(pedLocal_97, veLocal_115, false))
				if (VEHICLE::DOES_VEHICLE_HAVE_STUCK_VEHICLE_CHECK(veLocal_115))
					if (VEHICLE::IS_VEHICLE_STUCK_ON_ROOF(veLocal_115))
						flag = true;
			else if (!VEHICLE::IS_VEHICLE_DRIVEABLE(veLocal_115, false) || !func_183(pedLocal_97, joaat("SCRIPT_TASK_VEHICLE_MISSION") /*SCRIPT_TASK_VEHICLE_MISSION*/))
				flag = true;
		
			if (!PED::IS_PED_FLEEING(pedLocal_97))
				if (TASK::GET_SCRIPT_TASK_STATUS(pedLocal_97, joaat("SCRIPT_TASK_VEHICLE_MISSION") /*SCRIPT_TASK_VEHICLE_MISSION*/) == 7)
					flag = true;
			...
			if (flag)
			{
				if (!bLocal_136)
				{
					...
					{
						if (TASK::GET_SCRIPT_TASK_STATUS(pedLocal_97, joaat("SCRIPT_TASK_PERFORM_SEQUENCE") /*SCRIPT_TASK_PERFORM_SEQUENCE*/) != 1 && TASK::GET_SCRIPT_TASK_STATUS(pedLocal_97, joaat("SCRIPT_TASK_PERFORM_SEQUENCE") /*SCRIPT_TASK_PERFORM_SEQUENCE*/) != 0)
						{
					...
					else if (TASK::GET_SCRIPT_TASK_STATUS(pedLocal_97, joaat("SCRIPT_TASK_PERFORM_SEQUENCE") /*SCRIPT_TASK_PERFORM_SEQUENCE*/) != 1 && TASK::GET_SCRIPT_TASK_STATUS(pedLocal_97, joaat("SCRIPT_TASK_PERFORM_SEQUENCE") /*SCRIPT_TASK_PERFORM_SEQUENCE*/) != 0)
					{
						TASK::OPEN_SEQUENCE_TASK(&iLocal_104);
						TASK::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 300f, -1, false, false);
						TASK::CLOSE_SEQUENCE_TASK(iLocal_104);
	...
	switch (iLocal_107)
	{
		...
		case 2:
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(veLocal_115, false))
			{
				if (bLocal_336)
				{
					if (PED::IS_PED_SITTING_IN_VEHICLE(pedLocal_97, veLocal_115) || TASK::GET_SCRIPT_TASK_STATUS(pedLocal_97, joaat("SCRIPT_TASK_VEHICLE_MISSION") /*SCRIPT_TASK_VEHICLE_MISSION*/) == 1)
...
BOOL func_130() // Position - 0x7341 Hash - 0xCE0910 ^0xC662440
{
	...
	if (flag)
	{
		...
		else
		{
			...
			if (TASK::GET_SCRIPT_TASK_STATUS(pedLocal_98, joaat("SCRIPT_TASK_COWER") /*SCRIPT_TASK_COWER*/) != 1)
...
BOOL func_133() // Position - 0x74DA Hash - 0x1277BFDE ^0x96B94F42
{
	...
	if (flag)
	{
		...
		{
			if (TASK::GET_SCRIPT_TASK_STATUS(pedLocal_97, joaat("SCRIPT_TASK_SMART_FLEE_PED") /*SCRIPT_TASK_SMART_FLEE_PED*/) == 7)
			{
				PED::SET_PED_COMBAT_ATTRIBUTES(pedLocal_97, 17 /*BF_AlwaysFlee*/, true);
				PED::SET_PED_COMBAT_ATTRIBUTES(pedLocal_97, 13 /*BF_Aggressive*/, false);
				TASK::TASK_SMART_FLEE_PED(pedLocal_97, PLAYER::PLAYER_PED_ID(), 300f, -1, false, false);
...
BOOL func_163(ePedComponentType epctParam0) // Position - 0x8775 Hash - 0xA439E034 ^0x14CB4DD5
{
...
BOOL func_198() // Position - 0x992D Hash - 0xFB14126D ^0xFB14126D
{
	...
	if (func_200())
	{
		...
		pedLocal_98 = PED::CREATE_PED(5 /*PED_TYPE_CIVFEMALE*/, hLocal_155, uLocal_93, fLocal_96, true, true);
		PED::SET_PED_COMBAT_ATTRIBUTES(pedLocal_98, 13 /*BF_Aggressive*/, false);
		PED::SET_PED_COMBAT_ATTRIBUTES(pedLocal_98, 11 /*BF_0x0036D422*/, true);
		PED::SET_PED_COMBAT_ATTRIBUTES(pedLocal_98, 17 /*BF_AlwaysFlee*/, false);
		PED::SET_PED_COMPONENT_VARIATION(pedLocal_98, 6 /*PV_COMP_FEET*/, 1, 0, 0);
		...
		if (iLocal_113 == 1)
		{
			PED::SET_PED_COMPONENT_VARIATION(pedLocal_98, 0 /*PV_COMP_HEAD*/, 0, 0, 0);
			PED::SET_PED_COMPONENT_VARIATION(pedLocal_98, 2 /*PV_COMP_HAIR*/, 0, 1, 0);
			PED::SET_PED_COMPONENT_VARIATION(pedLocal_98, 3 /*PV_COMP_UPPR*/, 0, 1, 0);
			PED::SET_PED_COMPONENT_VARIATION(pedLocal_98, 4 /*PV_COMP_LOWR*/, 0, 2, 0);
		}
	
		pedLocal_97 = PED::CREATE_PED(22 /*PED_TYPE_CRIMINAL*/, hLocal_154, uLocal_93, 0, true, true);
		PED::SET_PED_COMBAT_ATTRIBUTES(pedLocal_97, 17 /*BF_AlwaysFlee*/, true);
		PED::SET_PED_COMBAT_ATTRIBUTES(pedLocal_97, 13 /*BF_Aggressive*/, false);
		PED::SET_PED_COMBAT_ATTRIBUTES(pedLocal_97, 6 /*BF_0x66BB9FCC*/, true);
		...
		if (iLocal_107 == 1 || iLocal_107 == 2)
		{
			...
			else if (iLocal_107 == 1)
			{
				...
				PED::SET_PED_CAN_BE_KNOCKED_OFF_VEHICLE(pedLocal_97, 3 /*KNOCKOFFVEHICLE_HARD*/);
			}
			else if (iLocal_107 == 4)
			{
