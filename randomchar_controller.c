...
void func_58(eCharacter echParam0) // Position - 0x3093 Hash - 0xEC7DB104 ^0xEC7DB104
{
	...
	func_59(0 /*CHAR_MICHAEL*/);
	func_59(1 /*CHAR_FRANKLIN*/);
	func_59(2 /*CHAR_TREVOR*/);
	return;
}
...
int func_62(eCharacter echParam0) // Position - 0x3382 Hash - 0x523E24 ^0x941A30AC
{
	eCharacter character;
...
void func_63(eCharacter echParam0, eCharacter echParam1) // Position - 0x33D8 Hash - 0xB539F413 ^0x1156AFD6
{
	eCharacter character;
	...
	else if (Global_113056[iParam0 /*10*/].f_3)
	{
		...
		else
		{
			if (iParam0 == 10 && Global_113969.f_7264[109] != 1)
				func_107(109 /*CHAR_STRIPPER_INFERNUS*/, 1);
		...
		if (func_105(&(Global_113056[iParam0 /*10*/].f_8)))
		{
			...
			else
			{
				...
				else if (num5 == 2)
				{
					...
					if (func_94(unk.f_26, 2 /*CHAR_TREVOR*/))
...
void func_96(int iParam0, int iParam1) // Position - 0x4930 Hash - 0x644AA5C3 ^0x157D3F5C
{
	...
	else if (iParam1 == 2 || iParam1 == 3 || iParam1 == 4 || iParam1 == 7)
	{
		...
		else
		{
			...
			func_99(iParam0, 66 /*BLIP_RANDOM_CHARACTER*/);
		}
	}
...
BOOL func_128(int iParam0) // Position - 0x9329 Hash - 0x1EF1B1A5 ^0x1EF1B1A5
{
	if (iParam0 == 58 || iParam0 == 59 || iParam0 == 62)
		if (func_129(40) || func_129(41 /*CHAR_PEGASUS_DELIVERY*/) || func_129(43 /*CHAR_TANISHA*/) || func_129(47 /*CHAR_CHEF*/))
			return true;

	if (iParam0 == 24)
		if (func_129(41 /*CHAR_PEGASUS_DELIVERY*/))
			return true;
