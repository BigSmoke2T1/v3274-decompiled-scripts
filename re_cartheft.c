...
void func_5(eCharacter echParam0, int iParam1, int iParam2) // Position - 0x17C6 Hash - 0xF0BE1C2C ^0x3B8D00E2
{
	int num;
	int num2;
...
void func_6(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x18B4 Hash - 0x99A9B13C ^0x970C9246
{
	Hash statName;
...
int func_10(int iParam0, int iParam1) // Position - 0x1937 Hash - 0x744E461C ^0x36023077
{
	Hash statHash;
	int outValue;
...
BOOL func_39(Player plParam0, int iParam1) // Position - 0x21FD Hash - 0x1A32E11A ^0x81C44B3D
{
	BOOL flag;
	...
	if (plParam0 == PLAYER::PLAYER_ID())
		flag = func_40(-1, false) == 8 /*CHAR_MIKE_FRANK_CONF*/;
	else
...
BOOL func_42(Player plParam0) // Position - 0x22B9 Hash - 0x68897CDD ^0x7A533860
{
...
void func_76() // Position - 0x329F Hash - 0x2E5252A9 ^0x8A59A06D
{
	if (!PED::IS_PED_INJURED(pedLocal_74))
	{
		PED::SET_PED_COMBAT_ATTRIBUTES(pedLocal_74, 2 /*BF_CanDoDrivebys*/, false);
		PED::SET_PED_COMBAT_ATTRIBUTES(pedLocal_74, 6 /*BF_0x66BB9FCC*/, false);
		PED::SET_PED_COMBAT_ATTRIBUTES(pedLocal_74, 3 /*BF_CanLeaveVehicle*/, true);
		PED::SET_PED_COMBAT_ATTRIBUTES(pedLocal_74, 1 /*BF_CanUseVehicles*/, false);
		TASK::TASK_COMBAT_PED(pedLocal_74, PLAYER::PLAYER_PED_ID(), 0, 16);
...
BOOL func_90(ePedComponentType epctParam0) // Position - 0x3CB4 Hash - 0xA439E034 ^0x14CB4DD5
{
		...
		switch (iLocal_48)
		{
			...
			case 1:
				if (iLocal_299 == 1)
				{
					...
					if (TASK::GET_SCRIPT_TASK_STATUS(pedLocal_73, joaat("SCRIPT_TASK_PERFORM_SEQUENCE") /*SCRIPT_TASK_PERFORM_SEQUENCE*/) != 1)
					{
						TASK::OPEN_SEQUENCE_TASK(&iLocal_76);
			...
			case 2:
				...
				if (iLocal_299 == 2)
				{
					if (!PED::IS_PED_FACING_PED(pedLocal_73, PLAYER::PLAYER_PED_ID(), 60f) && !func_118(pedLocal_73, joaat("SCRIPT_TASK_TURN_PED_TO_FACE_ENTITY") /*SCRIPT_TASK_TURN_PED_TO_FACE_ENTITY*/))
				...
				if (TASK::GET_SCRIPT_TASK_STATUS(pedLocal_73, joaat("SCRIPT_TASK_PERFORM_SEQUENCE") /*SCRIPT_TASK_PERFORM_SEQUENCE*/) != 1 && !func_118(pedLocal_73, joaat("SCRIPT_TASK_TURN_PED_TO_FACE_ENTITY") /*SCRIPT_TASK_TURN_PED_TO_FACE_ENTITY*/))
				{
					if (iLocal_299 == 1)
					{
						...
						{
							if (TASK::GET_SCRIPT_TASK_STATUS(pedLocal_73, joaat("SCRIPT_TASK_PERFORM_SEQUENCE") /*SCRIPT_TASK_PERFORM_SEQUENCE*/) == 7)
							{
								TASK::OPEN_SEQUENCE_TASK(&iLocal_76);
			...
			case 3:
				...
				else
				{
					...
					if (!ENTITY::IS_ENTITY_AT_COORD(pedLocal_73, uLocal_91, 4f, 4f, 4f, false, true, 0))
						if (TASK::GET_SCRIPT_TASK_STATUS(pedLocal_73, joaat("SCRIPT_TASK_GO_STRAIGHT_TO_COORD") /*SCRIPT_TASK_GO_STRAIGHT_TO_COORD*/) == 7)
...
BOOL func_172() // Position - 0x7293 Hash - 0x2F3F55EE ^0x2F3F55EE
{
	...
	if (STREAMING::HAS_MODEL_LOADED(model) && STREAMING::HAS_MODEL_LOADED(model2) && STREAMING::HAS_MODEL_LOADED(model3) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_81) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_82) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_83) && STREAMING::HAS_ANIM_DICT_LOADED("RANDOM@CAR_THIEF@WAITING_IG_4") && STREAMING::HAS_PTFX_ASSET_LOADED())
	{
		if (iLocal_299 == 1)
		{
			...
			pedLocal_74 = PED::CREATE_PED_INSIDE_VEHICLE(veLocal_75, 22 /*PED_TYPE_CRIMINAL*/, model2, -1, true, true);
			...
			pedLocal_73 = PED::CREATE_PED(5 /*PED_TYPE_CIVFEMALE*/, model, uLocal_50, fLocal_53, true, true);
			AUDIO::SET_AMBIENT_VOICE_NAME(pedLocal_73, name);
			TASK::TASK_LOOK_AT_ENTITY(pedLocal_73, PLAYER::PLAYER_PED_ID(), -1, 2048 /*SLF_WHILE_NOT_IN_FOV*/, 2);
			PED::SET_PED_COMPONENT_VARIATION(pedLocal_73, 0 /*PV_COMP_HEAD*/, 0, 1, 0);
			PED::SET_PED_COMPONENT_VARIATION(pedLocal_73, 2 /*PV_COMP_HAIR*/, 2, 0, 0);
			PED::SET_PED_COMPONENT_VARIATION(pedLocal_73, 3 /*PV_COMP_UPPR*/, 1, 1, 0);
			PED::SET_PED_COMPONENT_VARIATION(pedLocal_73, 4 /*PV_COMP_LOWR*/, 1, 1, 0);
		...
		else
		{
			...
			if (bLocal_59)
				pedLocal_73 = PED::CREATE_PED(5 /*PED_TYPE_CIVFEMALE*/, model, -490.4008f, -2160.7551f, 8.2498f, 314.0037f, true, true);
				...
				pedLocal_73 = PED::CREATE_PED(5 /*PED_TYPE_CIVFEMALE*/, model, -486.81f, -2156.99f, 8.27f, -172.34f, true, true);
			else
				pedLocal_73 = PED::CREATE_PED(5 /*PED_TYPE_CIVFEMALE*/, model, -486.2511f, -2161.808f, 8.3041f, 353.4264f, true, true);
		
			PED::SET_PED_COMPONENT_VARIATION(pedLocal_73, 0 /*PV_COMP_HEAD*/, 0, 0, 0);
			PED::SET_PED_COMPONENT_VARIATION(pedLocal_73, 2 /*PV_COMP_HAIR*/, 1, 0, 0);
			PED::SET_PED_COMPONENT_VARIATION(pedLocal_73, 3 /*PV_COMP_UPPR*/, 1, 2, 0);
			PED::SET_PED_COMPONENT_VARIATION(pedLocal_73, 4 /*PV_COMP_LOWR*/, 1, 2, 0);
			pedLocal_74 = PED::CREATE_PED_INSIDE_VEHICLE(veLocal_75, 22 /*PED_TYPE_CRIMINAL*/, model2, -1, true, true);
			WEAPON::GIVE_WEAPON_TO_PED(pedLocal_74, joaat("WEAPON_PISTOL"), -1, true, true);
			PED::SET_PED_ACCURACY(pedLocal_74, 10);
			PED::SET_DRIVER_ABILITY(pedLocal_74, 1f);
		...
		PED::SET_PED_COMBAT_ATTRIBUTES(pedLocal_73, 17 /*BF_AlwaysFlee*/, false);
