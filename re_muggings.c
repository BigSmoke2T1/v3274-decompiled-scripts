		...
		if (BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE() || bLocal_147)
		{
			switch (iLocal_44)
			{
				...
				case 1:
					...
					{
						if (shLocal_139 == 0)
							shLocal_139 = EVENT::ADD_SHOCKING_EVENT_AT_POSITION(101 /*EVENT_SHOCKING_MUGGING*/, uLocal_120, 0f);
							...
							case 2:
								...
								switch (iLocal_47)
								{
									...
									case 4:
										...
										if (TASK::GET_SCRIPT_TASK_STATUS(pedLocal_60, joaat("SCRIPT_TASK_PERFORM_SEQUENCE") /*SCRIPT_TASK_PERFORM_SEQUENCE*/) == 7)
										{
					...
					if (bLocal_147 && !bLocal_148)
					{
						if (!PED::IS_PED_INJURED(pedLocal_61))
						{
							if (iLocal_88 == 3)
							{
								if (TASK::GET_SCRIPT_TASK_STATUS(pedLocal_61, joaat("SCRIPT_TASK_SMART_FLEE_PED") /*SCRIPT_TASK_SMART_FLEE_PED*/) != 1)
								{
							...
							else if (TASK::GET_SCRIPT_TASK_STATUS(pedLocal_61, joaat("SCRIPT_TASK_SMART_FLEE_PED") /*SCRIPT_TASK_SMART_FLEE_PED*/) != 1)
							{
								TASK::CLEAR_PED_SECONDARY_TASK(pedLocal_61);
								TASK::TASK_SMART_FLEE_PED(pedLocal_61, PLAYER::PLAYER_PED_ID(), 200f, -1, false, false);
								PED::FORCE_PED_MOTION_STATE(pedLocal_61, joaat("MotionState_Run"), true, 0, false);
...
BOOL func_15(ePedComponentType epctParam0) // Position - 0x147A Hash - 0xA439E034 ^0x14CB4DD5
{
			...
			if (bLocal_49)
			{
				if (OBJECT::DOES_PICKUP_EXIST(pkLocal_189))
				{
					if (OBJECT::DOES_PICKUP_OBJECT_EXIST(pkLocal_189))
					{
						...
						else if (TASK::GET_SCRIPT_TASK_STATUS(pedLocal_60, joaat("SCRIPT_TASK_PERFORM_SEQUENCE") /*SCRIPT_TASK_PERFORM_SEQUENCE*/) == 7)
						{
							TASK::CLEAR_PED_TASKS(pedLocal_60);
							TASK::OPEN_SEQUENCE_TASK(&iLocal_119);
...
void func_71(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x42D0 Hash - 0x99A9B13C ^0x970C9246
{
	Hash statName;
...
int func_78(int iParam0, int iParam1) // Position - 0x4531 Hash - 0x744E461C ^0x36023077
{
	Hash statHash;
	int outValue;
...
BOOL func_116(Player plParam0, int iParam1) // Position - 0x5920 Hash - 0x1A32E11A ^0x81C44B3D
{
	BOOL flag;
...
BOOL func_119(Player plParam0) // Position - 0x59DC Hash - 0x68897CDD ^0x7A533860
{
	...
	if (!PED::IS_PED_INJURED(pedLocal_60))
	{
		...
		if (bLocal_51)
		{
			if (!bLocal_134)
			{
				...
				{
					if (TASK::GET_SCRIPT_TASK_STATUS(pedLocal_60, joaat("SCRIPT_TASK_PERFORM_SEQUENCE") /*SCRIPT_TASK_PERFORM_SEQUENCE*/) == 1)
					{
		...
		if (bLocal_131)
		{
			...
			else
			{
				switch (iLocal_665)
				{
					...
					case 1:
						if (TASK::GET_SCRIPT_TASK_STATUS(pedLocal_61, joaat("SCRIPT_TASK_PERFORM_SEQUENCE") /*SCRIPT_TASK_PERFORM_SEQUENCE*/) == 7)
						{
							uLocal_668 = { OBJECT::GET_PICKUP_COORDS(pkLocal_189) - { 0f, 0f, 0.75f } };
		...
		case 5:
			if (SYSTEM::TIMERB() > 250)
			{
				if (ENTITY::DOES_ENTITY_EXIST(pedLocal_61))
				{
					if (!PED::IS_PED_INJURED(pedLocal_61))
					{
						PED::SET_PED_COMBAT_ATTRIBUTES(pedLocal_61, 17 /*BF_AlwaysFlee*/, true);
...
void func_212() // Position - 0xA991 Hash - 0xC17CFD41 ^0x3F3D32A8
{
	if (!PED::IS_PED_INJURED(pedLocal_60))
	{
		if (!PED::IS_PED_RAGDOLL(pedLocal_60))
		{
			if (func_197())
			{
				if (TASK::GET_SCRIPT_TASK_STATUS(pedLocal_60, joaat("SCRIPT_TASK_PERFORM_SEQUENCE") /*SCRIPT_TASK_PERFORM_SEQUENCE*/) == 7 || TASK::GET_SCRIPT_TASK_STATUS(pedLocal_60, joaat("SCRIPT_TASK_COWER") /*SCRIPT_TASK_COWER*/) == 7)
				{
					if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
						func_109();
...
{
	pedLocal_60 = PED::CREATE_PED(26 /*PED_TYPE_MISSION*/, hLocal_81, uLocal_67, fLocal_73, true, true);
	...
	{
		PED::SET_PED_COMPONENT_VARIATION(pedLocal_60, 0 /*PV_COMP_HEAD*/, 1, 0, 0);
		PED::SET_PED_COMPONENT_VARIATION(pedLocal_60, 3 /*PV_COMP_UPPR*/, 0, 3, 0);
		PED::SET_PED_COMPONENT_VARIATION(pedLocal_60, 4 /*PV_COMP_LOWR*/, 0, 2, 0);
	}

	if (hLocal_81 == joaat("A_M_Y_Business_02"))
	{
		PED::SET_PED_COMPONENT_VARIATION(pedLocal_60, 0 /*PV_COMP_HEAD*/, 1, 0, 0);
		PED::SET_PED_COMPONENT_VARIATION(pedLocal_60, 2 /*PV_COMP_HAIR*/, 1, 0, 0);
		PED::SET_PED_COMPONENT_VARIATION(pedLocal_60, 3 /*PV_COMP_UPPR*/, 1, 0, 0);
		PED::SET_PED_COMPONENT_VARIATION(pedLocal_60, 4 /*PV_COMP_LOWR*/, 1, 0, 0);
		PED::SET_PED_COMPONENT_VARIATION(pedLocal_60, 8 /*PV_COMP_ACCS*/, 0, 0, 0);
	}

	PED::ADD_RELATIONSHIP_GROUP("theAssailant", &hLocal_84);
	pedLocal_61 = PED::CREATE_PED(26 /*PED_TYPE_MISSION*/, hLocal_82, uLocal_70, fLocal_76, true, true);
	ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(pedLocal_61, true, 1);
	...
	PED::SET_PED_COMBAT_ATTRIBUTES(pedLocal_61, 13 /*BF_Aggressive*/, false);
	PED::SET_PED_COMBAT_ATTRIBUTES(pedLocal_61, 17 /*BF_AlwaysFlee*/, false);
	...
	if (bLocal_154)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(pedLocal_60))
		{
			if (!PED::IS_PED_INJURED(pedLocal_60))
			{
				...
				if (TASK::GET_SCRIPT_TASK_STATUS(pedLocal_60, joaat("SCRIPT_TASK_WANDER_STANDARD") /*SCRIPT_TASK_WANDER_STANDARD*/) == 7 && TASK::GET_SCRIPT_TASK_STATUS(pedLocal_60, joaat("SCRIPT_TASK_PERFORM_SEQUENCE") /*SCRIPT_TASK_PERFORM_SEQUENCE*/) == 7)
				{
					TASK::OPEN_SEQUENCE_TASK(&iLocal_119);
